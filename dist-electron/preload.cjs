...
electron.contextBridge.exposeInMainWorld("electron", {
  ...
  onUpdateProgress: (cb) => electron.ipcRenderer.on("update:progress", (_e, percent) => cb(percent)),
  addOfflineAccount: (username) => electron.ipcRenderer.invoke("accounts:addOffline", username),
  // settings
