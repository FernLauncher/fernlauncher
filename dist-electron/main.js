...
var ki = (e, t, n) => sv(e, typeof t != "symbol" ? t + "" : t, n), Xa = (e, t, n) => t.has(e) || Tf("Cannot " + n);
var ue = (e, t, n) => (Xa(e, t, "read from private field"), n ? n.call(e) : t.get(e)), Yt = (e, t, n) => t.has(e) ? Tf("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n), Ft = (e, t, n, r) => (Xa(e, t, "write to private field"), r ? r.call(e, n) : t.set(e, n), n), En = (e, t, n) => (Xa(e, t, "access private method"), n);
import An, { app as tt, ipcMain as ie, BrowserWindow as $e, shell as Ki, dialog as Yr } from "electron";
import k, { dirname as _p, join as ct } from "path";
import rr, { fileURLToPath as wp } from "url";
import Le from "node:process";
import Se from "node:path";
import { promisify as pt, isDeepStrictEqual as Af } from "node:util";
import fe from "node:fs";
import Ui from "node:crypto";
...
const qn = $p.homedir(), Tl = $p.tmpdir(), { env: ni } = Le, dv = (e) => {
  ...
  const t = ni.APPDATA || Se.join(qn, "AppData", "Roaming"), n = ni.LOCALAPPDATA || Se.join(qn, "AppData", "Local");
  return {
  ...
  return {
    data: Se.join(ni.XDG_DATA_HOME || Se.join(qn, ".local", "share"), e),
    config: Se.join(ni.XDG_CONFIG_HOME || Se.join(qn, ".config"), e),
    cache: Se.join(ni.XDG_CACHE_HOME || Se.join(qn, ".cache"), e),
    // https://wiki.debian.org/XDGBaseDirectorySpecification#state
    log: Se.join(ni.XDG_STATE_HOME || Se.join(qn, ".local", "state"), e),
    temp: Se.join(Tl, t, e)
  };
};
function mv(e, { suffix: t = "nodejs" } = {}) {
  if (typeof e != "string")
    throw new TypeError(`Expected a string, got ${typeof e}`);
  return t && (e += `-${t}`), Le.platform === "darwin" ? dv(e) : Le.platform === "win32" ? hv(e) : pv(e);
}
const Dn = (e, t) => {
  const { onError: n } = t;
  return function(...i) {
...
}, vv = "utf8", If = 438, Ev = 511, _v = {}, wv = Le.geteuid ? Le.geteuid() : -1, $v = Le.getegid ? Le.getegid() : -1, Sv = 1e3, bv = !!Le.getuid;
Le.getuid && Le.getuid();
const Pf = 128, Tv = (e) => e instanceof Error && "code" in e, Of = (e) => typeof e == "string", ec = (e) => e === void 0, Av = Le.platform === "linux", Pp = Le.platform === "win32", Al = ["SIGHUP", "SIGINT", "SIGTERM"];
Pp || Al.push("SIGALRM", "SIGABRT", "SIGVTALRM", "SIGXCPU", "SIGXFSZ", "SIGUSR2", "SIGTRAP", "SIGSYS", "SIGQUIT", "SIGIOT");
Av && Al.push("SIGIO", "SIGPOLL", "SIGPWR", "SIGSTKFLT");
class Cv {
  /* CONSTRUCTOR */
  constructor() {
    this.callbacks = /* @__PURE__ */ new Set(), this.exited = !1, this.exit = (t) => {
      if (!this.exited) {
        ...
        for (const n of this.callbacks)
          n();
        t && (Pp && t !== "SIGINT" && t !== "SIGTERM" && t !== "SIGKILL" ? Le.kill(Le.pid, "SIGTERM") : Le.kill(Le.pid, t));
      }
    }, this.hook = () => {
...
var Jc = { exports: {} }, Nl = {}, Kt = {}, mi = {}, No = {}, le = {}, co = {};
(function(e) {
  ...
  class r extends t {
    ...
    get str() {
      var g;
      return (g = this._str) !== null && g !== void 0 ? g : this._str = this._items.reduce((w, T) => `${w}${T}`, "");
    }
    get names() {
      var g;
      return (g = this._names) !== null && g !== void 0 ? g : this._names = this._items.reduce((w, T) => (T instanceof n && (w[T.str] = (w[T.str] || 0) + 1), w), {});
    }
  }
  ...
  function s(y, ...g) {
    ...
    let T = 0;
    for (; T < g.length; )
      w.push(o), a(w, g[T]), w.push(o, d(y[++T]));
    return c(w), new r(w);
  }
  e.str = s;
  function a(y, g) {
...
(function(e) {
  ...
  class s extends o {
    constructor($, A, M) {
      super(), this.varKind = $, this.name = A, this.rhs = M;
    }
    render({ es5: $, _n: A }) {
      const M = $ ? n.varKinds.var : this.varKind, re = this.rhs === void 0 ? "" : ` = ${this.rhs}`;
      return `${M} ${this.name}${re};` + A;
    }
    optimizeNames($, A) {
      if ($[this.name.str])
        return this.rhs && (this.rhs = D(this.rhs, $, A)), this;
    }
    get names() {
  ...
  class a extends o {
    constructor($, A, M) {
      super(), this.lhs = $, this.rhs = A, this.sideEffects = M;
    }
    render({ _n: $ }) {
    ...
    optimizeNames($, A) {
      if (!(this.lhs instanceof t.Name && !$[this.lhs.str] && !this.sideEffects))
        return this.rhs = D(this.rhs, $, A), this;
    }
    get names() {
  ...
  class h extends o {
    ...
    optimizeNames($, A) {
      return this.code = D(this.code, $, A), this;
    }
    get names() {
  ...
  class d extends o {
    ...
    render($) {
      return this.nodes.reduce((A, M) => A + M.render($), "");
    }
    optimizeNodes() {
      const { nodes: $ } = this;
      let A = $.length;
      for (; A--; ) {
        const M = $[A].optimizeNodes();
        Array.isArray(M) ? $.splice(A, 1, ...M) : M ? $[A] = M : $.splice(A, 1);
      }
    ...
    optimizeNames($, A) {
      ...
      for (; re--; ) {
        const te = M[re];
        te.optimizeNames($, A) || (L($, te.names), M.splice(re, 1));
      }
      return M.length > 0 ? this : void 0;
    }
    get names() {
      return this.nodes.reduce(($, A) => V($, A.names), {});
    }
  }
  class m extends d {
    render($) {
  ...
  class y extends m {
    constructor($, A) {
      super(A), this.condition = $;
    }
    render($) {
      let A = `if(${this.condition})` + super.render($);
      return this.else && (A += "else " + this.else.render($)), A;
    }
    optimizeNodes() {
      super.optimizeNodes();
      ...
      if (A) {
        const M = A.optimizeNodes();
        A = this.else = Array.isArray(M) ? new v(M) : M;
      }
      if (A)
        return $ === !1 ? A instanceof y ? A : A.nodes : this.nodes.length ? this : new y(G($), A instanceof y ? [A] : A.nodes);
      if (!($ === !1 || !this.nodes.length))
        return this;
    }
    optimizeNames($, A) {
      var M;
      if (this.else = (M = this.else) === null || M === void 0 ? void 0 : M.optimizeNames($, A), !!(super.optimizeNames($, A) || this.else))
        return this.condition = D(this.condition, $, A), this;
    }
    get names() {
      const $ = super.names;
  ...
  class w extends g {
    ...
    optimizeNames($, A) {
      if (super.optimizeNames($, A))
        return this.iteration = D(this.iteration, $, A), this;
    }
    get names() {
  ...
  class T extends g {
    constructor($, A, M, re) {
      super(), this.varKind = $, this.name = A, this.from = M, this.to = re;
    }
    render($) {
      const A = $.es5 ? n.varKinds.var : this.varKind, { name: M, from: re, to: te } = this;
      return `for(${A} ${M}=${re}; ${M}<${te}; ${M}++)` + super.render($);
    }
    get names() {
  ...
  class C extends g {
    constructor($, A, M, re) {
      super(), this.loop = $, this.varKind = A, this.name = M, this.iterable = re;
    }
    render($) {
    ...
    optimizeNames($, A) {
      if (super.optimizeNames($, A))
        return this.iterable = D(this.iterable, $, A), this;
    }
    get names() {
  ...
  class F extends m {
    constructor($, A, M) {
      super(), this.name = $, this.args = A, this.async = M;
    }
    render($) {
  ...
  class K extends m {
    render($) {
      ...
      return this.catch && (A += this.catch.render($)), this.finally && (A += this.finally.render($)), A;
    }
    optimizeNodes() {
      var $, A;
      return super.optimizeNodes(), ($ = this.catch) === null || $ === void 0 || $.optimizeNodes(), (A = this.finally) === null || A === void 0 || A.optimizeNodes(), this;
    }
    optimizeNames($, A) {
      var M, re;
      return super.optimizeNames($, A), (M = this.catch) === null || M === void 0 || M.optimizeNames($, A), (re = this.finally) === null || re === void 0 || re.optimizeNames($, A), this;
    }
    get names() {
      const $ = super.names;
...
` : "" }, this._extScope = $, this._scope = new n.Scope({ parent: $ }), this._nodes = [new p()];
    ...
    const($, A, M) {
      return this._def(n.varKinds.const, $, A, M);
    }
    // `let` declaration with optional assignment (`var` in es5 mode)
    let($, A, M) {
      return this._def(n.varKinds.let, $, A, M);
    }
    // `var` declaration with optional assignment
    var($, A, M) {
      return this._def(n.varKinds.var, $, A, M);
    }
    // assignment code
    assign($, A, M) {
      return this._leafNode(new a($, A, M));
    }
    // `+=` code
    add($, A) {
      return this._leafNode(new c($, e.operators.ADD, A));
    }
    ...
    object(...$) {
      const A = ["{"];
      for (const [M, re] of $)
        A.length > 1 && A.push(","), A.push(M), (M !== re || this.opts.es5) && (A.push(":"), (0, t.addCodeArg)(A, re));
      return A.push("}"), new t._Code(A);
    }
    // `if` clause (or statement if `thenBody` and, optionally, `elseBody` are passed)
    if($, A, M) {
      if (this._blockNode(new y($)), A && M)
        this.code(A).else().code(M).endIf();
      else if (A)
        this.code(A).endIf();
      else if (M)
    ...
    _for($, A) {
      return this._blockNode($), A && this.code(A).endFor(), this;
    }
    // a generic `for` clause (or statement if `forBody` is passed)
    for($, A) {
      return this._for(new w($), A);
    }
    // `for` statement for a range of values
    forRange($, A, M, re, te = this.opts.es5 ? n.varKinds.var : n.varKinds.let) {
      const ye = this._scope.toName($);
      return this._for(new T(te, ye, A, M), () => re(ye));
    }
    // `for-of` statement (in es5 mode replace with a normal for loop)
    forOf($, A, M, re = n.varKinds.const) {
      const te = this._scope.toName($);
      if (this.opts.es5) {
        const ye = A instanceof t.Name ? A : this.var("_arr", A);
        return this.forRange("_i", 0, (0, t._)`${ye}.length`, (pe) => {
          this.var(te, (0, t._)`${ye}[${pe}]`), M(te);
        });
      }
      return this._for(new C("of", re, te, A), () => M(te));
    }
    // `for-in` statement.
    // With option `ownProperties` replaced with a `for-of` loop for object keys
    forIn($, A, M, re = this.opts.es5 ? n.varKinds.var : n.varKinds.const) {
      if (this.opts.ownProperties)
        return this.forOf($, (0, t._)`Object.keys(${A})`, M);
      const te = this._scope.toName($);
      return this._for(new C("in", re, te, A), () => M(te));
    }
    // end `for` loop
    endFor() {
    ...
    return($) {
      const A = new q();
      if (this._blockNode(A), this.code($), A.nodes.length !== 1)
    ...
    try($, A, M) {
      ...
      const re = new K();
      if (this._blockNode(re), this.code($), A) {
        const te = this.name("e");
        this._currNode = re.catch = new H(te), A(te);
      }
    ...
    block($, A) {
      return this._blockStarts.push(this._nodes.length), $ && this.code($).endBlock(A), this;
    }
    ...
    func($, A = t.nil, M, re) {
      return this._blockNode(new F($, A, M)), re && this.code(re).endFunc(), this;
    }
    ...
    _endBlockNode($, A) {
      ...
      if (M instanceof $ || A && M instanceof A)
        return this._nodes.pop(), this;
      throw new Error(`CodeGen: not in block "${A ? `${$.kind}/${A.kind}` : $.kind}"`);
    }
    _elseNode($) {
      const A = this._currNode;
      if (!(A instanceof y))
        throw new Error('CodeGen: "else" without "if"');
      return this._currNode = A.else = $, this;
    }
    get _root() {
  ...
  function D(O, $, A) {
    ...
    function re(te) {
      return te instanceof t._Code && te._items.some((ye) => ye instanceof t.Name && $[ye.str] === 1 && A[ye.str] !== void 0);
    }
  }
  function L(O, $) {
    for (const A in $)
  ...
  e.or = B;
  function N(O) {
    return ($, A) => $ === t.nil ? A : A === t.nil ? $ : (0, t._)`${R($)} ${O} ${R(A)}`;
  }
  function R(O) {
...
(function(e) {
  ...
  function i(v, y = e.keywordError, g, w) {
    const { it: T } = v, { gen: C, compositeRule: F, allErrors: q } = T, K = f(v, y, g);
    w ?? (F || q) ? c(C, K) : u(T, (0, t._)`[${K}]`);
  }
  e.reportError = i;
  function o(v, y = e.keywordError, g) {
    const { it: w } = v, { gen: T, compositeRule: C, allErrors: F } = w, q = f(v, y, g);
    c(T, q), C || F || u(w, r.default.vErrors);
  }
  ...
  function a({ gen: v, keyword: y, schemaValue: g, data: w, errsCount: T, it: C }) {
    if (T === void 0)
      throw new Error("ajv implementation error");
    const F = v.name("err");
    v.forRange("i", T, r.default.errors, (q) => {
  ...
  function u(v, y) {
    const { gen: g, validateName: w, schemaEnv: T } = v;
    T.$async ? g.throw((0, t._)`new ${v.ValidationError}(${y})`) : (g.assign((0, t._)`${w}.errors`, y), g.return(!1));
  }
  const l = {
  ...
  function m({ keyword: v, it: { errSchemaPath: y } }, { schemaPath: g, parentSchema: w }) {
    let T = w ? y : (0, t.str)`${y}/${v}`;
    return g && (T = (0, t.str)`${T}${(0, n.getErrorPath)(g, n.Type.Str)}`), [l.schemaPath, T];
  }
  function p(v, { params: y, message: g }, w) {
    const { keyword: T, data: C, schemaValue: F, it: q } = v, { opts: K, propertyName: H, topSchemaRef: S, schemaPath: j } = q;
    w.push([l.keyword, T], [l.params, typeof y == "function" ? y(v) : y || (0, t._)`{}`]), K.messages && w.push([l.message, typeof g == "function" ? g(v) : g]), K.verbose && w.push([l.schema, F], [l.parentSchema, (0, t._)`${S}${j}`], [r.default.data, C]), H && w.push([l.propertyName, H]);
  }
})(No);
Object.defineProperty(mi, "__esModule", { value: !0 });
mi.boolOrEmptySchema = mi.topBoolOrEmptySchema = void 0;
...
const Zv = Or, Qv = bn, eE = No, he = le, Mp = Q;
var ui;
(function(e) {
...
function nE(e, t) {
  ...
  if (s) {
    const a = Ol(t, r, i.strictNumbers, ui.Wrong);
    n.if(a, () => {
...
function Zc(e, t, n, r = ui.Correct) {
  const i = r === ui.Correct ? he.operators.EQ : he.operators.NEQ;
  let o;
  switch (e) {
    case "null":
  ...
  return r === ui.Correct ? o : (0, he.not)(o);
  function s(a = he.nil) {
...
function Ff(e, t, n) {
  ...
  if (n === void 0)
    return;
  const a = (0, Br._)`${o}${(0, Br.getProperty)(t)}`;
  if (i) {
    (0, cE.checkStrictMode)(e, `default is ignored for: ${a}`);
    return;
  }
  let c = (0, Br._)`${a} === undefined`;
  s.useDefaults === "empty" && (c = (0, Br._)`${c} || ${a} === null || ${a} === ""`), r.if(c, (0, Br._)`${a} = ${(0, Br.stringify)(n)}`);
}
var dn = {}, ge = {};
...
function bE(e, t) {
  ...
  function p(y = t.async ? (0, Tt._)`await ` : Tt.nil) {
    const g = c.opts.passContext ? yr.default.this : yr.default.self, w = !("compile" in t && !a || t.schema === !1);
    r.assign(f, (0, Tt._)`${y}${(0, wE.callValidateCode)(e, l, g, w)}`, t.modifying);
  }
  function v(y) {
    var g;
...
function TE(e, t) {
  ...
  n.if((0, Tt._)`Array.isArray(${t})`, () => {
    n.assign(yr.default.vErrors, (0, Tt._)`${yr.default.vErrors} === null ? ${t} : ${yr.default.vErrors}.concat(${t})`).assign(yr.default.errors, (0, Tt._)`${yr.default.vErrors}.length`), (0, $E.extendErrors)(e);
  }, () => e.error());
}
...
function As(e, t, n, r, i, o, s, a, c, u) {
      ...
      if (Array.isArray(f)) {
        if (l in Wn.arrayKeywords)
          for (var h = 0; h < f.length; h++)
            As(e, t, n, f[h], i + "/" + l + "/" + h, o, i, l, r, h);
      } else if (l in Wn.propsKeywords) {
        if (f && typeof f == "object")
          for (var d in f)
            As(e, t, n, f[d], i + "/" + l + "/" + RE(d), o, i, l, r, d);
      } else (l in Wn.keywords || e.allKeys && !(l in Wn.skipKeywords)) && As(e, t, n, f, i + "/" + l, o, i, l, r);
    }
    n(r, i, o, s, a, c, u);
  }
}
...
function qE(e, t) {
  if (typeof e == "boolean")
    return {};
  const { schemaId: n, uriResolver: r } = this.opts, i = fi(e[n] || t), o = { "": i }, s = Yp(r, i, !1), a = {}, c = /* @__PURE__ */ new Set();
  return xE(e, { allKeys: !0 }, (f, h, d, m) => {
    ...
    function y(w) {
      ...
      if (w = fi(v ? T(v, w) : w), c.has(w))
        throw l(w);
      c.add(w);
      let C = this.refs[w];
      return typeof C == "string" && (C = this.refs[C]), typeof C == "object" ? u(f, C.schema, w) : w !== fi(p) && (w[0] === "#" ? (u(f, a[w], w), a[w] = f) : this.refs[w] = p), w;
    }
    function g(w) {
      if (typeof w == "string") {
        if (!HE.test(w))
...
const Zp = mi, xf = Ye, xl = bn, ks = Ye, zE = sa, Qi = dn, tc = Yn, se = le, ce = Ht, VE = at, Tn = Q, ji = No;
function GE(e) {
  if (tm(e) && (nm(e), em(e))) {
    JE(e);
    return;
...
function QE(e) {
  ...
  t.$ref && r.ignoreKeywordsWithRef && (0, Tn.schemaHasRulesButRef)(t, i.RULES) && i.logger.warn(`$ref: keywords ignored in schema at path "${n}"`);
}
function e_(e) {
...
function Uf(e, t, n, r) {
  ...
  if (o.$ref && (c.ignoreKeywordsWithRef || !(0, Tn.schemaHasRulesButRef)(o, l))) {
...
class sm {
  ...
  _error(t, n) {
    (t ? ji.reportExtraError : ji.reportError)(this, this.def.error, n);
  }
  $dataError() {
  ...
  mergeEvaluated(t, n) {
    ...
    r.opts.unevaluated && (r.props !== !0 && t.props !== void 0 && (r.props = Tn.mergeEvaluated.props(i, t.props, r.props, n)), r.items !== !0 && t.items !== void 0 && (r.items = Tn.mergeEvaluated.items(i, t.items, r.items, n)));
  }
...
function cm(e, { dataLevel: t, dataNames: n, dataPathArr: r }) {
  ...
  const a = i.split("/");
  for (const u of a)
    u && (o = (0, se._)`${o}${(0, se.getProperty)((0, Tn.unescapeJsonPointer)(u))}`, s = (0, se._)`${s} && ${o}`);
  return s;
  function c(u, l) {
...
const Xt = le, m_ = wi, fr = Ht, nn = at, Mf = Q, g_ = Kt;
class aa {
  constructor(t) {
    var n;
...
const $_ = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", S_ = "Meta-schema for $data reference (JSON AnySchema extension proposal)", b_ = "object", T_ = [
  "$data"
], A_ = {
  $data: {
    type: "string",
...
(function(e) {
  ...
  const r = wi, i = Lr, o = Or, s = At, a = le, c = at, u = Ye, l = Q, f = N_, h = jl, d = (B, N) => new RegExp(B, N);
  d.code = "new RegExp";
  ...
  function w(B) {
    var N, R, O, $, A, M, re, te, ye, pe, Re, _, E, U, I, me, be, Ae, xe, ke, Ze, Oe, X, ve, Ee;
    const _e = B.strict, Ce = (N = B.code) === null || N === void 0 ? void 0 : N.optimize, ft = Ce === !0 || Ce === void 0 ? 1 : Ce || 0, Qe = (O = (R = B.code) === null || R === void 0 ? void 0 : R.regExp) !== null && O !== void 0 ? O : d, dt = ($ = B.uriResolver) !== null && $ !== void 0 ? $ : h.default;
    return {
      strictSchema: (M = (A = B.strictSchema) !== null && A !== void 0 ? A : _e) !== null && M !== void 0 ? M : !0,
      strictNumbers: (te = (re = B.strictNumbers) !== null && re !== void 0 ? re : _e) !== null && te !== void 0 ? te : !0,
      strictTypes: (pe = (ye = B.strictTypes) !== null && ye !== void 0 ? ye : _e) !== null && pe !== void 0 ? pe : "log",
      strictTuples: (_ = (Re = B.strictTuples) !== null && Re !== void 0 ? Re : _e) !== null && _ !== void 0 ? _ : "log",
      strictRequired: (U = (E = B.strictRequired) !== null && E !== void 0 ? E : _e) !== null && U !== void 0 ? U : !1,
      code: B.code ? { ...B.code, optimize: ft, regExp: Qe } : { optimize: ft, regExp: Qe },
      ...
      messages: (Ae = B.messages) !== null && Ae !== void 0 ? Ae : !0,
      inlineRefs: (xe = B.inlineRefs) !== null && xe !== void 0 ? xe : !0,
      schemaId: (ke = B.schemaId) !== null && ke !== void 0 ? ke : "$id",
      addUsedSchema: (Ze = B.addUsedSchema) !== null && Ze !== void 0 ? Ze : !0,
  ...
  class T {
    ...
    compileAsync(N, R) {
      ...
      async function te(pe) {
        ...
        this.refs[pe] || await A.call(this, Re.$schema), this.refs[pe] || this.addSchema(Re, pe, R);
      }
    ...
    addSchema(N, R, O, $ = this.opts.validateSchema) {
      ...
      if (typeof N == "object") {
        ...
        if (A = N[M], A !== void 0 && typeof A != "string")
          throw new Error(`schema ${M} must be string`);
      }
      return R = (0, c.normalizeId)(R || A), this._checkUnique(R), this.schemas[R] = this._addSchema(N, O, R, $, !0), this;
    }
    ...
    addKeyword(N, R) {
      ...
      if (D.call(this, O, R), !R)
        return (0, l.eachItem)(O, (A) => L.call(this, A)), this;
      z.call(this, R);
      const $ = {
        ...R,
      ...
      return (0, l.eachItem)(O, $.type.length === 0 ? (A) => L.call(this, A, $) : (A) => $.type.forEach((M) => L.call(this, A, $, M))), this;
    }
    getKeyword(N) {
    ...
    removeKeyword(N) {
      ...
      for (const O of R.rules) {
        const $ = O.rules.findIndex((A) => A.keyword === N);
        $ >= 0 && O.rules.splice($, 1);
      }
      return this;
    }
    ...
    errorsText(N = this.errors, { separator: R = ", ", dataVar: O = "data" } = {}) {
      return !N || N.length === 0 ? "No errors" : N.map(($) => `${O}${$.instancePath} ${$.message}`).reduce(($, A) => $ + R + A);
    }
    $dataMetaSchema(N, R) {
    ...
    _addSchema(N, R, O, $ = this.opts.validateSchema, A = this.opts.addUsedSchema) {
      let M;
      ...
      return te = new s.SchemaEnv({ schema: N, schemaId: re, meta: R, baseId: O, localRefs: ye }), this._cache.set(te.schema, te), A && !O.startsWith("#") && (O && this._checkUnique(O), this.refs[O] = te), $ && this.validateSchema(N, !0), te;
    }
    _checkUnique(N) {
  ...
  function C(B, N, R, O = "error") {
    for (const $ in B) {
      const A = $;
      A in N && this.logger[O](`${R}: option ${$}. ${B[A]}`);
    }
  }
  function F(B) {
  ...
  function L(B, N, R) {
    ...
    const { RULES: A } = this;
    let M = $ ? A.post : A.rules.find(({ type: te }) => te === R);
    if (M || (M = { type: R, rules: [] }, A.rules.push(M)), A.keywords[B] = !0, !N)
      return;
    const re = {
      keyword: B,
      definition: {
    ...
    N.before ? G.call(this, M, re, N.before) : M.rules.push(re), A.all[B] = re, (O = N.implements) === null || O === void 0 || O.forEach((te) => this.addKeyword(te));
  }
  function G(B, N, R) {
...
const aw = Lr, Hf = ge, xt = le, Hr = Ht, qf = At, Qo = Q, cw = {
  keyword: "$ref",
  schemaType: "string",
  code(e) {
...
Nn.getValidate = wm;
function Ns(e, t, n, r) {
  const { gen: i, it: o } = e, { allErrors: s, schemaEnv: a, opts: c } = o, u = c.passContext ? Hr.default.this : xt.nil;
  r ? l() : f();
  function l() {
    if (!a.$async)
  ...
  function h(m) {
    ...
    i.assign(Hr.default.vErrors, (0, xt._)`${Hr.default.vErrors} === null ? ${p} : ${Hr.default.vErrors}.concat(${p})`), i.assign(Hr.default.errors, (0, xt._)`${Hr.default.vErrors}.length`);
  }
  function d(m) {
    var p;
...
const vr = le, gw = Q, yw = Wl, vw = {
  message({ keyword: e, schemaCode: t }) {
    const n = e === "maxLength" ? "more" : "fewer";
    return (0, vr.str)`must NOT have ${n} than ${t} characters`;
  },
  ...
  error: vw,
  code(e) {
    const { keyword: t, data: n, schemaCode: r, it: i } = e, o = t === "maxLength" ? vr.operators.GT : vr.operators.LT, s = i.opts.unicode === !1 ? (0, vr._)`${n}.length` : (0, vr._)`${(0, gw.useFunc)(e.gen, yw.default)}(${n})`;
    e.fail$data((0, vr._)`${s} ${o} ${r}`);
  }
};
Gl.default = Ew;
var Kl = {};
Object.defineProperty(Kl, "__esModule", { value: !0 });
const _w = ge, ww = Q, ii = le, $w = {
  ...
  code(e) {
    ...
    if (r) {
      const { regExp: c } = s.opts.code, u = c.code === "new RegExp" ? (0, ii._)`new RegExp` : (0, ww.useFunc)(t, c), l = t.let("valid");
      t.try(() => t.assign(l, (0, ii._)`${u}(${o}, ${a}).test(${n})`), () => t.assign(l, !1)), e.fail$data((0, ii._)`!${l}`);
    } else {
      const c = (0, _w.usePattern)(e, i);
      e.fail$data((0, ii._)`!${c}.test(${n})`);
    }
  }
};
Kl.default = Sw;
    ...
    if (s.allErrors ? u() : l(), a.strictRequired) {
      ...
      for (const p of n)
        if ((d == null ? void 0 : d[p]) === void 0 && !m.has(p)) {
          ...
          (0, Aw.checkStrictMode)(s, y, s.opts.strictRequired);
        }
    }
    function u() {
      if (c || o)
        ...
        for (const d of n)
          (0, Mi.checkReportMissingProp)(e, d);
    }
    function l() {
      ...
      if (c || o) {
        ...
        t.if((0, Mi.checkMissingProp)(e, n, d)), (0, Mi.reportMissingProp)(e, d), t.else();
    }
    function f() {
      t.forOf("prop", r, (d) => {
        e.setParams({ missingProperty: d }), t.if((0, Mi.noPropertyInData)(t, i, d, a.ownProperties), () => e.error());
      });
    }
    function h(d, m) {
      e.setParams({ missingProperty: d }), t.forOf(d, r, () => {
        t.assign(m, (0, Mi.propertyInData)(t, i, d, a.ownProperties)), t.if((0, no.not)(m), () => {
          e.error(), t.break();
        });
      }, no.nil);
    }
...
Io.default = Sm;
Object.defineProperty(Zl, "__esModule", { value: !0 });
const ic = Ye, st = le, Ow = Q, Rw = Io, Dw = {
  message: ({ params: { i: e, j: t } }) => (0, st.str)`must NOT have duplicate items (items ## ${t} and ${e} are identical)`,
  params: ({ params: { i: e, j: t } }) => (0, st._)`{i: ${e}, j: ${t}}`
}, Fw = {
  keyword: "uniqueItems",
  type: "array",
  schemaType: "boolean",
  ...
  code(e) {
    ...
    e.block$data(c, l, (0, st._)`${s} === false`), e.ok(c);
    function l() {
      const m = t.let("i", (0, st._)`${n}.length`), p = t.let("j");
      e.setParams({ i: m, j: p }), t.assign(c, !0), t.if((0, st._)`${m} > 1`, () => (f() ? h : d)(m, p));
    }
    function f() {
      return u.length > 0 && !u.some((m) => m === "object" || m === "array");
    }
    function h(m, p) {
      const v = t.name("item"), y = (0, ic.checkDataTypes)(u, v, a.opts.strictNumbers, ic.DataType.Wrong), g = t.const("indices", (0, st._)`{}`);
      t.for((0, st._)`;${m}--;`, () => {
        t.let(v, (0, st._)`${n}[${m}]`), t.if(y, (0, st._)`continue`), u.length > 1 && t.if((0, st._)`typeof ${v} == "string"`, (0, st._)`${v} += "_"`), t.if((0, st._)`typeof ${g}[${v}] == "number"`, () => {
          t.assign(p, (0, st._)`${g}[${v}]`), e.error(), t.assign(c, !1).break();
        }).code((0, st._)`${g}[${v}] = ${m}`);
      });
    }
    function d(m, p) {
      const v = (0, Ow.useFunc)(t, Rw.default), y = t.name("outer");
      t.label(y).for((0, st._)`;${m}--;`, () => t.for((0, st._)`${p} = ${m}; ${p}--;`, () => t.if((0, st._)`${v}(${n}[${m}], ${n}[${p}])`, () => {
...
$i.validateAdditionalItems = void 0;
const Er = le, tl = Q, e$ = {
...
function bm(e, t) {
  ...
  s.items = !0;
  const a = n.const("len", (0, Er._)`${i}.length`);
  if (r === !1)
    e.setParams({ len: t.length }), e.pass((0, Er._)`${a} <= ${t.length}`);
  else if (typeof r == "object" && !(0, tl.alwaysValidSchema)(s, r)) {
    const u = n.var("valid", (0, Er._)`${a} <= ${t.length}`);
    n.if((0, Er.not)(u), () => c(u)), e.ok(u);
  }
  function c(u) {
    n.forRange("i", t.length, a, (l) => {
      e.subschema({ keyword: o, dataProp: l, dataPropType: tl.Type.Num }, u), s.allErrors || n.if((0, Er.not)(u), () => n.break());
    });
  }
}
$i.validateAdditionalItems = bm;
$i.default = t$;
var tu = {}, Si = {};
Object.defineProperty(Si, "__esModule", { value: !0 });
Si.validateTuple = void 0;
...
const Ps = le, A$ = Q, C$ = {
  ...
  code(e) {
    ...
    function u() {
      o.forEach((l, f) => {
        let h;
        (0, A$.alwaysValidSchema)(i, l) ? t.var(c, !0) : h = e.subschema({
          keyword: "oneOf",
          schemaProp: f,
          compositeRule: !0
...
const L$ = $i, x$ = tu, k$ = Si, U$ = nu, j$ = ru, M$ = ha, B$ = iu, H$ = pa, q$ = ou, z$ = su, V$ = au, G$ = cu, W$ = lu, K$ = uu, J$ = fu, Y$ = du;
function X$(e = !1) {
  const t = [
    // any
    V$.default,
...
bi.dynamicAnchor = void 0;
const sc = le, Z$ = Ht, Zf = At, Q$ = Nn, eS = {
...
const lS = bi, uS = Ti, fS = pu, dS = mu, hS = [lS.default, uS.default, fS.default, dS.default];
hu.default = hS;
var gu = {}, yu = {};
...
const _r = le, rd = Q, AS = {
  ...
  code(e) {
    ...
    if (o === !0)
      return;
    const s = t.const("len", (0, _r._)`${r}.length`);
    if (n === !1)
      e.setParams({ len: o }), e.fail((0, _r._)`${s} > ${o}`);
    else if (typeof n == "object" && !(0, rd.alwaysValidSchema)(i, n)) {
      const c = t.var("valid", (0, _r._)`${s} <= ${o}`);
      t.if((0, _r.not)(c), () => a(c, o)), e.ok(c);
    }
    i.items = !0;
    function a(c, u) {
      t.forRange("i", u, s, (l) => {
        e.subschema({ keyword: "unevaluatedItems", dataProp: l, dataPropType: rd.Type.Num }, c), i.allErrors || t.if((0, _r.not)(c), () => t.break());
      });
    }
  }
};
  ...
  code(e, t) {
    ...
    function h() {
      const m = n.scopeValue("formats", {
        ref: f.formats,
        code: c.code.formats
      }), p = n.const("fDef", (0, Ge._)`${m}[${s}]`), v = n.let("fType"), y = n.let("format");
      n.if((0, Ge._)`typeof ${p} == "object" && !(${p} instanceof RegExp)`, () => n.assign(v, (0, Ge._)`${p}.type || "string"`).assign(y, (0, Ge._)`${p}.validate`), () => n.assign(v, (0, Ge._)`"string"`).assign(y, p)), e.fail$data((0, Ge.or)(g(), w()));
      function g() {
        return c.strictSchema === !1 ? Ge.nil : (0, Ge._)`${s} && !${y}`;
      }
      function w() {
        const T = l.$async ? (0, Ge._)`(${p}.async ? await ${y}(${r}) : ${y}(${r}))` : (0, Ge._)`${y}(${r})`, C = (0, Ge._)`(typeof ${y} == "function" ? ${T} : ${y}.test(${r}))`;
        return (0, Ge._)`${y} && ${y} !== true && ${v} === ${t} && !${C}`;
      }
    }
    function d() {
      const m = f.formats[o];
      ...
      function w(C) {
        const F = C instanceof RegExp ? (0, Ge.regexpCode)(C) : c.code.formats ? (0, Ge._)`${c.code.formats}${(0, Ge.getProperty)(o)}` : void 0, q = n.scopeValue("formats", { key: o, ref: C, code: F });
        return typeof C == "object" && !(C instanceof RegExp) ? [C.type || "string", C.validate, (0, Ge._)`${q}.validate`] : ["string", C, q];
      }
      function T() {
        if (typeof m == "object" && !(m instanceof RegExp) && m.async) {
          if (!l.$async)
            throw new Error("async format in sync schema");
          return (0, Ge._)`await ${y}(${r})`;
        }
        return typeof v == "function" ? (0, Ge._)`${y}(${r})` : (0, Ge._)`${y}.test(${r})`;
      }
    }
  }
};
...
const LS = ua, xS = fa, kS = da, US = hu, jS = gu, MS = _u, BS = ma, id = Rr, HS = [
  US.default,
  LS.default,
  xS.default,
  (0, kS.default)(!0),
...
const Xr = le, nl = ya, sd = At, qS = Lr, zS = Q, VS = {
  ...
  code(e) {
    ...
    const c = t.let("valid", !1), u = t.const("tag", (0, Xr._)`${n}${(0, Xr.getProperty)(a)}`);
    t.if((0, Xr._)`typeof ${u} == "string"`, () => l(), () => e.error(!1, { discrError: nl.DiscrError.Tag, tag: u, tagName: a })), e.ok(c);
    function l() {
      const d = h();
      t.if(!1);
      for (const m in d)
        t.elseIf((0, Xr._)`${u} === ${m}`), t.assign(c, f(d[m]));
    ...
    function f(d) {
      ...
      return e.mergeEvaluated(p, Xr.Name), m;
    }
    function h() {
      var d;
      const m = {}, p = y(i);
...
const WS = "https://json-schema.org/draft/2020-12/schema", KS = "https://json-schema.org/draft/2020-12/schema", JS = {
  ...
  "https://json-schema.org/draft/2020-12/vocab/content": !0
}, Sb = "meta", bb = "Content vocabulary meta-schema", Tb = [
  "object",
  "boolean"
], Ab = {
  contentEncoding: {
  ...
  type: Yb,
  properties: Xb
}, Qb = "https://json-schema.org/draft/2020-12/schema", eT = "https://json-schema.org/draft/2020-12/meta/validation", tT = {
  "https://json-schema.org/draft/2020-12/vocab/validation": !0
}, nT = "meta", rT = "Validation vocabulary meta-schema", iT = [
  "object",
  "boolean"
], oT = {
  type: {
...
const cT = nb, lT = fb, uT = Eb, fT = Cb, dT = xb, hT = zb, pT = Zb, mT = aT, gT = ["/properties"];
function yT(e) {
  return [
    cT,
    lT,
  ...
  function t(n, r) {
    return e ? n.$dataMetaSchema(r, gT) : r;
  }
}
bu.default = yT;
(function(e, t) {
...
var vT = Jc.exports, rl = { exports: {} }, Pm = {};
(function(e) {
  ...
  const T = -2147483648, C = 2 ** 31 - 1;
  function F(j) {
    return Number.isInteger(j) && j <= C && j >= T;
  }
  function q(j) {
...
var Om = {}, il = { exports: {} }, Tu = {};
Object.defineProperty(Tu, "__esModule", { value: !0 });
const ET = ua, _T = fa, wT = da, $T = ma, ad = Rr, ST = [
  ET.default,
  _T.default,
  (0, wT.default)(),
  $T.default,
...
Tu.default = ST;
const bT = "http://json-schema.org/draft-07/schema#", TT = "http://json-schema.org/draft-07/schema#", AT = "Core schema meta-schema", CT = {
  schemaArray: {
    type: "array",
    minItems: 1,
    items: {
...
(function(e, t) {
  ...
  const n = Nl, r = Tu, i = ga, o = PT, s = ["/properties"], a = "http://json-schema.org/draft-07/schema";
...
(function(e) {
  ...
  const t = OT, n = le, r = n.operators, i = {
    ...
    code(a) {
      ...
      function v() {
        const w = c.scopeValue("formats", {
          ref: m.formats,
          code: d.code.formats
        }), T = c.const("fmt", (0, n._)`${w}[${p.schemaCode}]`);
        a.fail$data((0, n.or)((0, n._)`typeof ${T} != "object"`, (0, n._)`${T} instanceof RegExp`, (0, n._)`typeof ${T}.compare != "function"`, g(T)));
      }
      function y() {
        const w = p.schema, T = m.formats[w];
        if (!T || T === !0)
          return;
...
var RT = rl.exports;
const DT = /* @__PURE__ */ Cl(RT), FT = (e, t, n, r) => {
  ...
  !LT(i, o) && r || Object.defineProperty(e, n, o);
}, LT = function(e, t) {
...
${t}`, UT = Object.getOwnPropertyDescriptor(Function.prototype, "toString"), jT = Object.getOwnPropertyDescriptor(Function.prototype.toString, "name"), MT = (e, t, n) => {
  const r = n === "" ? "" : `with ${n.trim()}() `, i = kT.bind(null, r, t.toString());
  Object.defineProperty(i, "name", jT);
  const { writable: o, enumerable: s, configurable: a } = UT;
  Object.defineProperty(e, "toString", { value: i, writable: o, enumerable: s, configurable: a });
};
function BT(e, t, { ignoreNonConfigurable: n = !1 } = {}) {
  const { name: r } = e;
  for (const i of Reflect.ownKeys(t))
    FT(e, t, i, n);
  return xT(e, t), MT(e, t, r), e;
}
const cd = (e, t = {}) => {
  ...
  return BT(u, e), u.cancel = () => {
    s && (clearTimeout(s), s = void 0), a && (clearTimeout(a), a = void 0);
  }, u;
};
var ol = { exports: {} };
const HT = "2.0.0", Rm = 256, qT = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, zT = 16, VT = Rm - 6, GT = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
const WT = typeof process == "object" && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? (...e) => console.error("SEMVER", ...e) : () => {
};
var Ea = WT;
(function(e, t) {
  const {
  ...
  const h = "[a-zA-Z0-9-]", d = [
    ...
    const w = m(y), T = f++;
    o(v, T, y), l[v] = T, c[T] = y, u[T] = w, s[T] = new RegExp(y, g ? "g" : void 0), a[T] = new RegExp(w, g ? "g" : void 0);
  };
...
var Po = ol.exports;
const KT = Object.freeze({ loose: !0 }), JT = Object.freeze({}), YT = (e) => e ? typeof e != "object" ? KT : e : JT;
var Au = YT;
const ld = /^[0-9]+$/, Dm = (e, t) => {
...
const is = Ea, { MAX_LENGTH: ud, MAX_SAFE_INTEGER: os } = va, { safeRe: ss, t: as } = Po, ZT = Au, { compareIdentifiers: ac } = Fm;
let QT = class cn {
  constructor(t, n) {
    if (n = ZT(n), t instanceof cn) {
...
var rA = nA;
const iA = Ai, oA = (e, t) => {
  const n = iA(e.trim().replace(/^[=v]+/, ""), t);
  return n ? n.version : null;
};
var sA = oA;
const dd = Pt, aA = (e, t, n, r, i) => {
...
var uA = lA;
const fA = Pt, dA = (e, t) => new fA(e, t).major;
var hA = dA;
const pA = Pt, mA = (e, t) => new pA(e, t).minor;
var gA = mA;
const yA = Pt, vA = (e, t) => new yA(e, t).patch;
var EA = vA;
const _A = Ai, wA = (e, t) => {
  const n = _A(e, t);
...
var $A = wA;
const pd = Pt, SA = (e, t, n) => new pd(e, n).compare(new pd(t, n));
var rn = SA;
const bA = rn, TA = (e, t, n) => bA(t, e, n);
var AA = TA;
const CA = rn, NA = (e, t) => CA(e, t, !0);
var IA = NA;
const md = Pt, PA = (e, t, n) => {
  const r = new md(e, n), i = new md(t, n);
  return r.compare(i) || r.compareBuild(i);
};
var Cu = PA;
const OA = Cu, RA = (e, t) => e.sort((n, r) => OA(n, r, t));
var DA = RA;
const FA = Cu, LA = (e, t) => e.sort((n, r) => FA(r, n, t));
var xA = LA;
const kA = rn, UA = (e, t, n) => kA(e, t, n) > 0;
var _a = UA;
const jA = rn, MA = (e, t, n) => jA(e, t, n) < 0;
var Nu = MA;
const BA = rn, HA = (e, t, n) => BA(e, t, n) === 0;
var Lm = HA;
const qA = rn, zA = (e, t, n) => qA(e, t, n) !== 0;
var xm = zA;
const VA = rn, GA = (e, t, n) => VA(e, t, n) >= 0;
var Iu = GA;
const WA = rn, KA = (e, t, n) => WA(e, t, n) <= 0;
var Pu = KA;
const JA = Lm, YA = xm, XA = _a, ZA = Iu, QA = Nu, eC = Pu, tC = (e, t, n, r) => {
  switch (t) {
    case "===":
...
var km = tC;
const nC = Pt, rC = Ai, { safeRe: cs, t: ls } = Po, iC = (e, t) => {
  if (e instanceof nC)
    return e;
...
function on() {
  ...
  class t {
    ...
    parseRange(L) {
      ...
      let N = L.split(" ").map((A) => g(A, this.options)).join(" ").split(/\s+/).map((A) => j(A, this.options));
      J && (N = N.filter((A) => (s("loose invalid filter", A, this.options), !!A.match(c[u.COMPARATORLOOSE])))), s("range list", N);
      const R = /* @__PURE__ */ new Map(), O = N.map((A) => new o(A, this.options));
      for (const A of O) {
        if (p(A))
          return [A];
        R.set(A.value, A);
  ...
  cc = t;
  const n = aC, r = new n(), i = Au, o = wa(), s = Ea, a = Pt, {
    safeRe: c,
    t: u,
    ...
    return G;
  }, g = (D, L) => (D = D.replace(c[u.BUILD], ""), s("comp", D, L), D = F(D, L), s("caret", D), D = T(D, L), s("tildes", D), D = K(D, L), s("xrange", D), D = S(D, L), s("stars", D), D), w = (D) => !D || D.toLowerCase() === "x" || D === "*", T = (D, L) => D.trim().split(/\s+/).map((G) => C(G, L)).join(" "), C = (D, L) => {
    ...
    return D.replace(G, (z, Y, J, B, N, R) => {
      ...
      const O = w(J), $ = O || w(B), A = $ || w(N), M = A;
      return Y === "=" && M && (Y = ""), R = L.includePrerelease ? "-0" : "", O ? Y === ">" || Y === "<" ? z = "<0.0.0-0" : z = "*" : Y && M ? ($ && (B = 0), N = 0, Y === ">" ? (Y = ">=", $ ? (J = +J + 1, B = 0, N = 0) : (B = +B + 1, N = 0)) : Y === "<=" && (Y = "<", $ ? J = +J + 1 : B = +B + 1), Y === "<" && (R = "-0"), z = `${Y + J}.${B}.${N}${R}`) : $ ? z = `>=${J}.0.0${R} <${+J + 1}.0.0-0` : A && (z = `>=${J}.${B}.0${R} <${J}.${+B + 1}.0-0`), s("xRange return", z), z;
    });
  }, S = (D, L) => (s("replaceStars", D, L), D.trim().replace(c[u.STAR], "")), j = (D, L) => (s("replaceGTE0", D, L), D.trim().replace(c[L.includePrerelease ? u.GTE0PRE : u.GTE0], "")), V = (D) => (L, G, z, Y, J, B, N, R, O, $, A, M) => (w(z) ? G = "" : w(Y) ? G = `>=${z}.0.0${D ? "-0" : ""}` : w(J) ? G = `>=${z}.${Y}.0${D ? "-0" : ""}` : B ? G = `>=${G}` : G = `>=${G}${D ? "-0" : ""}`, w(O) ? R = "" : w($) ? R = `<${+O + 1}.0.0-0` : w(A) ? R = `<${O}.${+$ + 1}.0-0` : M ? R = `<=${O}.${$}.${A}-${M}` : D ? R = `<${O}.${$}.${+A + 1}-0` : R = `<=${R}`, `${G} ${R}`.trim()), Z = (D, L, G) => {
...
function wa() {
  ...
  lc = t;
  const n = Au, { safeRe: r, t: i } = Po, o = km, s = Ea, a = Pt, c = on();
  return lc;
}
...
const $d = on(), Ru = wa(), { ANY: fc } = Ru, Bi = $a, Du = rn, VC = (e, t, n = {}) => {
  if (e === t)
    return !0;
  ...
  let i, o;
  for (const d of e)
    d.operator === ">" || d.operator === ">=" ? i = bd(i, d, n) : d.operator === "<" || d.operator === "<=" ? o = Td(o, d, n) : r.add(d.semver);
  if (r.size > 1)
    return null;
  let s;
  if (i && o) {
  ...
  for (const d of r) {
    if (i && !Bi(d, String(i), n) || o && !Bi(d, String(o), n))
      return null;
    for (const m of t)
      if (!Bi(d, String(m), n))
        return !1;
    ...
    if (l = l || d.operator === ">" || d.operator === ">=", u = u || d.operator === "<" || d.operator === "<=", i) {
      if (h && d.semver.prerelease && d.semver.prerelease.length && d.semver.major === h.major && d.semver.minor === h.minor && d.semver.patch === h.patch && (h = !1), d.operator === ">" || d.operator === ">=") {
        if (a = bd(i, d, n), a === d && a !== i)
          return !1;
      } else if (i.operator === ">=" && !Bi(i.semver, String(d), n))
        return !1;
    }
    if (o) {
      if (f && d.semver.prerelease && d.semver.prerelease.length && d.semver.major === f.major && d.semver.minor === f.minor && d.semver.patch === f.patch && (f = !1), d.operator === "<" || d.operator === "<=") {
        if (c = Td(o, d, n), c === d && c !== o)
          return !1;
      } else if (o.operator === "<=" && !Bi(o.semver, String(d), n))
        return !1;
    }
...
var KC = VC;
const dc = Po, Ad = va, JC = Pt, Cd = Fm, YC = Ai, XC = rA, ZC = sA, QC = cA, eN = uA, tN = hA, nN = gA, rN = EA, iN = $A, oN = rn, sN = AA, aN = IA, cN = Cu, lN = DA, uN = xA, fN = _a, dN = Nu, hN = Lm, pN = xm, mN = Iu, gN = Pu, yN = km, vN = oC, EN = wa(), _N = on(), wN = $a, $N = dC, SN = gC, bN = _C, TN = SC, AN = AC, CN = Ou, NN = xC, IN = jC, PN = BC, ON = zC, RN = KC;
var Fu = {
  parse: YC,
  valid: XC,
  clean: ZC,
  ...
  src: dc.src,
  tokens: dc.t,
  SEMVER_SPEC_VERSION: Ad.SEMVER_SPEC_VERSION,
  RELEASE_TYPES: Ad.RELEASE_TYPES,
  compareIdentifiers: Cd.compareIdentifiers,
  rcompareIdentifiers: Cd.rcompareIdentifiers
};
const qr = /* @__PURE__ */ Cl(Fu), DN = Object.prototype.toString, FN = "[object Uint8Array]", LN = "[object ArrayBuffer]";
function jm(e, t, n) {
...
var Vn, Gn, Tr, Lt, Gt, Ar, Cr, pi, ln, rt, Hm, qm, zm, Vm, Gm, Wm, Km, Jm;
class qN {
  constructor(t = {}) {
    Yt(this, rt);
    ki(this, "path");
    ...
    Yt(this, pi);
    Yt(this, ln);
    ki(this, "_deserialize", (t) => JSON.parse(t));
    ki(this, "_serialize", (t) => JSON.stringify(t, void 0, "	"));
    const n = En(this, rt, Hm).call(this, t);
    Ft(this, Lt, n), En(this, rt, qm).call(this, n), En(this, rt, Vm).call(this, n), En(this, rt, Gm).call(this, n), this.events = new EventTarget(), Ft(this, Gn, n.encryptionKey), Ft(this, Tr, n.encryptionAlgorithm ?? Nd), this.path = En(this, rt, Wm).call(this, n), En(this, rt, Km).call(this, n), n.watch && this._watch();
  }
  get(t, n) {
  ...
  get store() {
    ...
    try {
      ...
      return ((o) => {
        ...
        return ue(this, Ar) || this._validate(s), Object.assign(wn(), s);
      })(r);
    } catch (n) {
  ...
  set store(t) {
    ...
    ue(this, Ar) || this._validate(t), this._write(t), this.events.dispatchEvent(new Event("change"));
  }
  *[Symbol.iterator]() {
  ...
  */
  _closeWatcher() {
    ue(this, Cr) && (ue(this, Cr).close(), Ft(this, Cr, void 0)), ue(this, pi) && (fe.unwatchFile(this.path), Ft(this, pi, !1)), Ft(this, ln, void 0);
  }
  _decryptData(t) {
    const n = ue(this, Gn);
    if (!n)
      return typeof t == "string" ? t : fs(t);
    const r = ue(this, Tr), i = r === "aes-256-gcm" ? 16 : 0, o = ":".codePointAt(0), s = typeof t == "string" ? t.codePointAt(16) : t[16];
    if (!(o !== void 0 && s === o)) {
      if (r === "aes-256-cbc")
        return typeof t == "string" ? t : fs(t);
    ...
    const c = (d) => {
      ...
      const { ciphertext: m, authenticationTag: p } = c(f), v = Ui.pbkdf2Sync(n, d, 1e4, 32, "sha512"), y = Ui.createDecipheriv(r, v, u);
  ...
  _write(t) {
    ...
    const r = ue(this, Gn);
    if (r) {
      const i = Ui.randomBytes(16), o = Ui.pbkdf2Sync(r, i, 1e4, 32, "sha512"), s = Ui.createCipheriv(ue(this, Tr), o, i), a = hc([s.update(pc(n)), s.final()]), c = [i, pc(":"), a];
      ue(this, Tr) === "aes-256-gcm" && c.push(s.getAuthTag()), n = hc(c);
    }
    if (Le.env.SNAP)
  ...
  _watch() {
    if (this._ensureDirectory(), fe.existsSync(this.path) || this._write(wn()), Le.platform === "win32" || Le.platform === "darwin") {
      ue(this, ln) ?? Ft(this, ln, cd(() => {
        this.events.dispatchEvent(new Event("change"));
      }, { wait: 100 }));
      const t = Se.dirname(this.path), n = Se.basename(this.path);
      Ft(this, Cr, fe.watch(t, { persistent: !1, encoding: "utf8" }, (r, i) => {
  ...
  _migrate(t, n, r) {
    ...
    (this._isVersionInRangeFormat(i) || !qr.eq(i, n)) && this._set(gc, n);
  }
  ...
  _isVersionInRangeFormat(t) {
    return qr.clean(t) === null;
  }
  _shouldPerformMigration(t, n, r) {
    return this._isVersionInRangeFormat(t) ? n !== "0.0.0" && qr.satisfies(n, t) ? !1 : qr.satisfies(r, t) : !(qr.lte(t, n) || qr.gt(t, r));
  }
  _get(t, n) {
...
Vn = new WeakMap(), Gn = new WeakMap(), Tr = new WeakMap(), Lt = new WeakMap(), Gt = new WeakMap(), Ar = new WeakMap(), Cr = new WeakMap(), pi = new WeakMap(), ln = new WeakMap(), rt = new WeakSet(), Hm = function(t) {
  const n = {
    configName: "config",
    fileExtension: "json",
  ...
  const n = DT.default, r = new vT.Ajv2020({
    allErrors: !0,
    useDefaults: !0,
    ...t.ajvOptions
  });
  ...
  Ft(this, Vn, r.compile(i)), En(this, rt, zm).call(this, t.schema);
}, zm = function(t) {
  ...
  if (t.migrations) {
    En(this, rt, Jm).call(this, t), this._validate(this.store);
    return;
  }
...
const { app: Os, ipcMain: sl, shell: zN } = An;
let Pd = !1;
const Od = () => {
  if (!sl || !Os)
...
class VN extends qN {
  constructor(t) {
    let n, r;
    if (Le.type === "renderer") {
      const i = An.ipcRenderer.sendSync("electron-store-get-data");
      if (!i)
        throw new Error("Electron Store: You need to call `.initRenderer()` from the main process.");
...
const KN = x, Je = k, Rd = Ym, JN = Sa, YN = typeof process == "object" && process.platform === "win32", Dd = (e) => typeof e == "object" && e !== null, Xm = new Uint32Array(256).map((e, t) => {
  for (let n = 0; n < 8; n++)
    t & 1 ? t = 3988292384 ^ t >>> 1 : t >>>= 1;
  return t >>> 0;
});
function Ve(e) {
  this.sep = Je.sep, this.fs = KN, Dd(e) && Dd(e.fs) && typeof e.fs.statSync == "function" && (this.fs = e.fs);
}
var XN = Ve;
...
Ve.prototype.writeFileTo = function(e, t, n, r) {
  const i = this;
...
Ve.prototype.writeFileToAsync = function(e, t, n, r, i) {
...
Ve.prototype.findFiles = function(e) {
  ...
  function n(r, i, o) {
    ...
    return t.fs.readdirSync(r).forEach(function(a) {
      const c = Je.join(r, a), u = t.fs.statSync(c);
      s.push(Je.normalize(c) + (u.isDirectory() ? t.sep : "")), u.isDirectory() && o && (s = s.concat(n(c, i, o)));
    }), s;
  }
  return n(e, void 0, !0);
};
Ve.prototype.findFilesAsync = function(e, t) {
  ...
  n.fs.readdir(e, function(i, o) {
    ...
    o.forEach(function(a) {
      a = Je.join(e, a), n.fs.stat(a, function(c, u) {
        if (c) return t(c);
        u && (r.push(Je.normalize(a) + (u.isDirectory() ? n.sep : "")), u.isDirectory() ? n.findFilesAsync(a, function(l, f) {
          if (l) return t(l);
...
Ve.crc32 = function(e) {
  ...
  let t = e.length, n = -1;
  for (let r = 0; r < t; ) n = Ve.crc32update(n, e[r++]);
  return ~n >>> 0;
};
...
Ve.canonical = function(e) {
  if (!e) return "";
  const t = Je.posix.normalize("/" + e.split("\\").join("/"));
  return Je.join(".", t);
};
Ve.zipnamefix = function(e) {
  if (!e) return "";
  const t = Je.posix.normalize("/" + e.split("\\").join("/"));
  return Je.posix.join(".", t);
};
...
Ve.sanitize = function(e, t) {
  e = Je.resolve(Je.normalize(e));
  for (var n = t.split("/"), r = 0, i = n.length; r < i; r++) {
    var o = Je.normalize(Je.join(e, n.slice(r, i).join(Je.sep)));
    if (o.indexOf(e) === 0)
      return o;
  }
  return Je.normalize(Je.join(e, Je.basename(t)));
};
Ve.toBuffer = function(t, n) {
...
Ci.exports = XN;
Ci.exports.Constants = Ym;
Ci.exports.Errors = Sa;
Ci.exports.FileAttr = QN;
Ci.exports.decoder = e1;
var Oo = Ci.exports, ba = {}, Bn = Oo, ee = Bn.Constants, t1 = function() {
  ...
  return i = Bn.fromDate2DOS(/* @__PURE__ */ new Date()), {
    ...
    loadLocalHeaderFromBinary: function(g) {
      ...
      const T = m + ee.LOCHDR + p.fnameLen, C = T + p.extraLen;
      return g.slice(T, C);
    },
...
}, Zr = Oo, je = Zr.Constants, n1 = function() {
  ...
  return {
    ...
    loadFromBinary: function(o) {
      if ((o.length !== je.ENDHDR || o.readUInt32LE(0) !== je.ENDSIG) && (o.length < je.ZIP64HDR || o.readUInt32LE(0) !== je.ZIP64SIG))
        throw Zr.Errors.INVALID_END();
      o.readUInt32LE(0) === je.ENDSIG ? (e = o.readUInt16LE(je.ENDSUB), t = o.readUInt16LE(je.ENDTOT), n = o.readUInt32LE(je.ENDSIZ), r = o.readUInt32LE(je.ENDOFF), i = o.readUInt16LE(je.ENDCOM)) : (e = Zr.readBigUInt64LE(o, je.ZIP64SUB), t = Zr.readBigUInt64LE(o, je.ZIP64TOT), n = Zr.readBigUInt64LE(o, je.ZIP64SIZE), r = Zr.readBigUInt64LE(o, je.ZIP64OFF), i = 0);
    },
    toBinary: function() {
      var o = Buffer.alloc(je.ENDHDR + i);
      return o.writeUInt32LE(je.ENDSIG, 0), o.writeUInt32LE(0, 4), o.writeUInt16LE(e, je.ENDSUB), o.writeUInt16LE(t, je.ENDTOT), o.writeUInt32LE(n, je.ENDSIZ), o.writeUInt32LE(r, je.ENDOFF), o.writeUInt16LE(i, je.ENDCOM), o.fill(" ", je.ENDHDR), o;
    },
    toJSON: function() {
...
ba.EntryHeader = t1;
ba.MainHeader = n1;
var Ta = {}, r1 = function(e) {
  var t = Ao, n = { chunkSize: (parseInt(e.length / 1024) + 1) * 1024 };
  return {
    deflate: function() {
...
const { randomFillSync: Fd } = _i, s1 = Sa, a1 = new Uint32Array(256).map((e, t) => {
  for (let n = 0; n < 8; n++)
...
Aa.prototype.updateKeys = function(e) {
  const t = this.keys;
...
Ta.Inflater = o1;
Ta.ZipCrypto = h1;
var Te = Oo, p1 = ba, ze = Te.Constants, yc = Ta, Qm = function(e, t) {
  var n = new p1.EntryHeader(), r = Buffer.alloc(0), i = Buffer.alloc(0), o = !1, s = null, a = Buffer.alloc(0), c = Buffer.alloc(0), u = !0;
  const l = e, f = typeof l.decoder == "object" ? l.decoder : Te.decoder;
  ...
  function d(w) {
    if (!n.flags_desc && !n.localHeader.flags_desc) {
      if (Te.crc32(w) !== n.localHeader.crc)
        return !1;
    } else {
      const T = {}, C = n.realDataOffset + n.compressedSize;
      if (t.readUInt32LE(C) == ze.LOCSIG || t.readUInt32LE(C) == ze.CENSIG)
        throw Te.Errors.DESCRIPTOR_NOT_EXIST();
      if (t.readUInt32LE(C) == ze.EXTSIG)
        T.crc = t.readUInt32LE(C + ze.EXTCRC), T.compressedSize = t.readUInt32LE(C + ze.EXTSIZ), T.size = t.readUInt32LE(C + ze.EXTLEN);
      else if (t.readUInt16LE(C + 12) === 19280)
        T.crc = t.readUInt32LE(C + ze.EXTCRC - 4), T.compressedSize = t.readUInt32LE(C + ze.EXTSIZ - 4), T.size = t.readUInt32LE(C + ze.EXTLEN - 4);
      else
        throw Te.Errors.DESCRIPTOR_UNKNOWN();
      if (T.compressedSize !== n.compressedSize || T.size !== n.size || T.crc !== n.crc)
        throw Te.Errors.DESCRIPTOR_FAULTY();
      if (Te.crc32(w) !== T.crc)
        return !1;
    }
    return !0;
  ...
  function m(w, T, C) {
    if (typeof T > "u" && typeof w == "string" && (C = w, w = void 0), o)
      return w && T && T(Buffer.alloc(0), Te.Errors.DIRECTORY_CONTENT_ERROR()), Buffer.alloc(0);
    var F = h();
    if (F.length === 0)
      return w && T && T(F), F;
    if (n.encrypted) {
      if (typeof C != "string" && !Buffer.isBuffer(C))
        throw Te.Errors.INVALID_PASS_PARAM();
      F = yc.ZipCrypto.decrypt(F, n, C);
    }
    var q = Buffer.alloc(n.size);
    switch (n.method) {
      case Te.Constants.STORED:
        if (F.copy(q), d(q))
          return w && T && T(q), q;
        throw w && T && T(q, Te.Errors.BAD_CRC()), Te.Errors.BAD_CRC();
      case Te.Constants.DEFLATED:
        var K = new yc.Inflater(F, n.size);
        if (w)
          K.inflateAsync(function(H) {
            H.copy(H, 0), T && (d(H) ? T(H) : T(H, Te.Errors.BAD_CRC()));
          });
        else {
          if (K.inflate(q).copy(q, 0), !d(q))
            throw Te.Errors.BAD_CRC(`"${f.decode(r)}"`);
          return q;
        }
        break;
      default:
        throw w && T && T(Buffer.alloc(0), Te.Errors.UNKNOWN_METHOD()), Te.Errors.UNKNOWN_METHOD();
    }
  }
  function p(w, T) {
    ...
    if (s.length && !o) {
      ...
      switch (n.method) {
        case Te.Constants.STORED:
          return n.compressedSize = n.size, C = Buffer.alloc(s.length), s.copy(C), w && T && T(C), C;
        default:
        case Te.Constants.DEFLATED:
          var F = new yc.Deflater(s);
          if (w)
            F.deflateAsync(function(K) {
              C = Buffer.alloc(K.length), n.compressedSize = K.length, K.copy(C), T && T(C);
            });
          else {
            var q = F.deflate();
  ...
  function v(w, T) {
    return Te.readBigUInt64LE(w, T);
  }
  function y(w) {
    try {
      for (var T = 0, C, F, q; T + 4 < w.length; )
        C = w.readUInt16LE(T), T += 2, F = w.readUInt16LE(T), T += 2, q = w.slice(T, T + F), T += F, ze.ID_ZIP64 === C && g(q);
    } catch {
      throw Te.Errors.EXTRA_FIELD_PARSE_ERROR();
    }
  }
  function g(w) {
    var T, C, F, q;
    w.length >= ze.EF_ZIP64_SCOMP && (T = v(w, ze.EF_ZIP64_SUNCOMP), n.size === ze.EF_ZIP64_OR_32 && (n.size = T)), w.length >= ze.EF_ZIP64_RHO && (C = v(w, ze.EF_ZIP64_SCOMP), n.compressedSize === ze.EF_ZIP64_OR_32 && (n.compressedSize = C)), w.length >= ze.EF_ZIP64_DSN && (F = v(w, ze.EF_ZIP64_RHO), n.offset === ze.EF_ZIP64_OR_32 && (n.offset = F)), w.length >= ze.EF_ZIP64_DSN + 4 && (q = w.readUInt32LE(ze.EF_ZIP64_DSN), n.diskNumStart === ze.EF_ZIP64_OR_16 && (n.diskNumStart = q));
  }
  return {
    get entryName() {
      return f.decode(r);
    ...
    set entryName(w) {
      r = Te.toBuffer(w, f.encode);
      var T = r[r.length - 1];
      o = T === 47 || T === 92, n.fileNameLength = r.length;
    },
    get efs() {
    ...
    set comment(w) {
      if (i = Te.toBuffer(w, f.encode), n.commentLength = i.length, i.length > 65535) throw Te.Errors.COMMENT_TOO_LONG();
    },
    get name() {
      var w = f.decode(r);
    ...
    setData: function(w) {
      s = Te.toBuffer(w, Te.decoder.encode), !o && s.length ? (n.size = s.length, n.method = Te.Constants.DEFLATED, n.crc = Te.crc32(w), n.changed = !0) : n.method = Te.Constants.STORED;
    },
    getData: function(w) {
      return n.changed ? s : m(!1, null, w);
    },
    getDataAsync: function(w, T) {
      n.changed ? w(s) : m(!0, w, T);
    },
    set attr(w) {
      n.attr = w;
    },
    ...
    packCentralHeader: function() {
      ...
      var w = n.centralHeaderToBinary(), T = Te.Constants.CENHDR;
      return r.copy(w, T), T += r.length, a.copy(w, T), T += n.extraLength, i.copy(w, T), w;
    },
    packLocalHeader: function() {
      let w = 0;
      n.flags_efs = this.efs, n.extraLocalLength = c.length;
      const T = n.localHeaderToBinary(), C = Buffer.alloc(T.length + r.length + n.extraLocalLength);
      return T.copy(C, w), w += T.length, r.copy(C, w), w += r.length, c.copy(C, w), w += c.length, C;
    },
    toJSON: function() {
      const w = function(T) {
...
var g1 = function(e, t) {
  ...
  function h() {
    if (s = !0, r = {}, o.diskEntries > (e.length - o.offset) / ot.Constants.CENHDR)
      throw ot.Errors.DISK_ENTRY_TOO_LARGE();
    n = new Array(o.diskEntries);
    for (var p = o.offset, v = 0; v < n.length; v++) {
      var y = p, g = new xd(c, e);
      g.header = e.slice(y, y += ot.Constants.CENHDR), g.entryName = e.slice(y, y += g.header.fileNameLength), g.header.extraLength && (g.extra = e.slice(y, y += g.header.extraLength)), g.header.commentLength && (g.comment = e.slice(y, y + g.header.commentLength)), p += g.header.centralHeaderSize, n[v] = g, r[g.entryName] = g;
    }
    a.clear(), f();
  }
  function d(p) {
    var v = e.length - ot.Constants.ENDHDR, y = Math.max(0, v - 65535), g = y, w = e.length, T = -1, C = 0;
    for ((typeof c.trailingSpace == "boolean" ? c.trailingSpace : !1) && (y = 0), v; v >= g; v--)
      if (e[v] === 80) {
        if (e.readUInt32LE(v) === ot.Constants.ENDSIG) {
          T = v, C = v, w = v + ot.Constants.ENDHDR, g = v - ot.Constants.END64HDR;
          continue;
        }
        if (e.readUInt32LE(v) === ot.Constants.END64SIG) {
          g = y;
          continue;
        }
        if (e.readUInt32LE(v) === ot.Constants.ZIP64SIG) {
          T = v, w = v + ot.readBigUInt64LE(e, v + ot.Constants.ZIP64SIZE) + ot.Constants.ZIP64LEAD;
          break;
        }
      }
    if (T == -1) throw ot.Errors.INVALID_FORMAT();
    o.loadFromBinary(e.slice(T, w)), o.commentLength && (i = e.slice(C + ot.Constants.ENDHDR)), p && h();
  }
  function m() {
  ...
  return {
    ...
    set comment(p) {
      i = ot.toBuffer(p, l.encode), o.commentLength = i.length;
    },
    ...
    compressToBuffer: function() {
      ...
      const T = Buffer.alloc(y);
      for (const F of p)
        F.copy(T, g), g += F.length;
      for (const F of v)
        F.copy(T, g), g += F.length;
      const C = o.toBinary();
      return i && i.copy(C, ot.Constants.ENDHDR), C.copy(T, g), e = T, s = !1, T;
    },
        ...
        const K = function(H) {
          if (H.length > 0) {
            ...
            y && y(j), S.getCompressedDataAsync(function(V) {
              ...
              T.push(L), o.size += L.length, C += D + L.length, q++, K(H);
            });
          } else {
            ...
            const j = o.toBinary();
            i && i.copy(j, ot.Constants.ENDHDR), j.copy(S, F), e = S, s = !1, p(S);
          }
        };
...
const Be = Oo, Me = k, y1 = Qm, v1 = g1, dr = (...e) => Be.findLast(e, (t) => typeof t == "boolean"), kd = (...e) => Be.findLast(e, (t) => typeof t == "string"), E1 = (...e) => Be.findLast(e, (t) => typeof t == "function"), _1 = {
  // option "noSort" : if true it disables files sorting
  noSort: !1,
  // read entries during load (initial loading may be slower)
  readEntries: !1,
  // default method is none
  method: Be.Constants.NONE,
  // file system
  fs: null
};
var w1 = function(e, t) {
  ...
  e && typeof e == "object" && (e instanceof Uint8Array || (Object.assign(r, e), e = r.input ? r.input : void 0, r.input && delete r.input), Buffer.isBuffer(e) && (n = e, r.method = Be.Constants.BUFFER, e = void 0)), Object.assign(r, t);
  const i = new Be(r);
  if ((typeof r.decoder != "object" || typeof r.decoder.encode != "function" || typeof r.decoder.decode != "function") && (r.decoder = Be.decoder), e && typeof e == "string")
    if (i.fs.existsSync(e))
      r.method = Be.Constants.FILE, r.filename = e, n = i.fs.readFileSync(e);
    else
      throw Be.Errors.INVALID_FILENAME();
  const o = new v1(n, r), { canonical: s, sanitize: a, zipnamefix: c } = Be;
  function u(d) {
    if (d && o) {
      var m;
      if (typeof d == "string" && (m = o.getEntry(Me.posix.normalize(d))), typeof d == "object" && typeof d.entryName < "u" && typeof d.header < "u" && (m = o.getEntry(d.entryName)), m)
        return m;
    }
    return null;
  }
  function l(d) {
    const { join: m, normalize: p, sep: v } = Me.posix;
    return m(Me.isAbsolute(d) ? "/" : ".", p(v + d.split("\\").join(v) + v));
  }
  function f(d) {
  ...
  const h = (d, m) => {
    let p = m.slice(-1);
    return p = p === i.sep ? i.sep : "", Me.relative(d, m) + p;
  };
  return {
    /**
    ...
    addLocalFileAsync: function(d, m) {
      ...
      const p = Me.resolve(d.localPath), { comment: v } = d;
      let { zipPath: y, zipName: g } = d;
      const w = this;
      i.fs.stat(p, function(T, C) {
        if (T) return m(T, !1);
        y = y ? l(y) : "";
        const F = Me.win32.basename(Me.win32.normalize(p));
        if (y += g || F, C.isFile())
    ...
    addLocalFolder: function(d, m, p) {
      if (p = f(p), m = m ? l(m) : "", d = Me.normalize(d), i.fs.existsSync(d)) {
        const v = i.findFiles(d), y = this;
        if (v.length)
          for (const g of v) {
            const w = Me.join(m, h(d, g));
            p(w) && y.addLocalFile(g, Me.dirname(w));
          }
      } else
        throw Be.Errors.FILE_NOT_FOUND(d);
    },
    ...
    addLocalFolderAsync: function(d, m, p, v) {
      v = f(v), p = p ? l(p) : "", d = Me.normalize(d);
      var y = this;
      i.fs.open(d, "r", function(g) {
        if (g && g.code === "ENOENT")
          m(void 0, Be.Errors.FILE_NOT_FOUND(d));
        else if (g)
          m(void 0, g);
        else {
          var w = i.findFiles(d), T = -1, C = function() {
            if (T += 1, T < w.length) {
              var F = w[T], q = h(d, F).split("\\").join("/");
    ...
    addLocalFolderAsync2: function(d, m) {
      const p = this;
      d = typeof d == "object" ? d : { localPath: d }, localPath = Me.resolve(l(d.localPath));
      ...
      const w = (C) => Me.join(v, g(h(localPath, C))), T = (C) => Me.win32.basename(Me.win32.normalize(g(C)));
      i.fs.open(localPath, "r", function(C) {
        C && C.code === "ENOENT" ? m(void 0, Be.Errors.FILE_NOT_FOUND(localPath)) : C ? m(void 0, C) : i.findFilesAsync(localPath, function(F, q) {
          if (F) return m(F);
    ...
    addFile: function(d, m, p, v) {
      ...
      var T = y.isDirectory ? 16 : 0;
      let C = y.isDirectory ? 16384 : 32768;
      return w ? C |= 4095 & v.mode : typeof v == "number" ? C |= 4095 & v : C |= y.isDirectory ? 493 : 420, T = (T | C << 16) >>> 0, y.attr = T, y.setData(m), g || o.setEntry(y), y;
    },
    /**
    ...
    extractEntryTo: function(d, m, p, v, y, g) {
      ...
      var w = u(d);
      if (!w)
        throw Be.Errors.NO_ENTRY();
      var T = s(w.entryName), C = a(m, g && !w.isDirectory ? g : p ? T : Me.basename(T));
      if (w.isDirectory) {
        ...
        return F.forEach(function(H) {
          ...
          var S = H.getData();
          if (!S)
            throw Be.Errors.CANT_EXTRACT_FILE();
          var j = s(H.entryName), V = a(m, p ? j : Me.basename(j));
          const Z = y ? H.header.fileAttr : void 0;
          i.writeFileTo(V, S, v, Z);
        }), !0;
      }
      var q = w.getData(o.password);
      if (!q) throw Be.Errors.CANT_EXTRACT_FILE();
      if (i.fs.existsSync(C) && !v)
        throw Be.Errors.CANT_OVERRIDE();
    ...
    extractAllTo: function(d, m, p, v) {
      if (p = dr(!1, p), v = kd(p, v), m = dr(!1, m), !o) throw Be.Errors.NO_ZIP();
      o.entries.forEach(function(y) {
        ...
        if (!w)
          throw Be.Errors.CANT_EXTRACT_FILE();
        const T = p ? y.header.fileAttr : void 0;
        i.writeFileTo(g, w, m, T);
        try {
    ...
    extractAllToAsync: function(d, m, p, v) {
      ...
      d = Me.resolve(d);
      const y = (C) => a(d, Me.normalize(s(C.entryName))), g = (C, F) => new Error(C + ': "' + F + '"'), w = [], T = [];
      o.entries.forEach((C) => {
        C.isDirectory ? w.push(C) : T.push(C);
      });
      for (const C of w) {
      ...
      T.reverse().reduce(function(C, F) {
        return function(q) {
          if (q)
            C(q);
          else {
            const K = Me.normalize(s(F.entryName)), H = a(d, K);
            F.getDataAsync(function(S, j) {
              if (j)
                C(j);
              else if (!S)
                C(Be.Errors.CANT_EXTRACT_FILE());
              else {
    ...
    writeZipPromise: function(d, m) {
      ...
      return new Promise((y, g) => {
        !d && r.filename && (d = r.filename), d || g("ADM-ZIP: ZIP File Name Missing"), this.toBufferPromise().then((w) => {
          const T = (C) => C ? y(C) : g("ADM-ZIP: Wasn't able to write zip file");
          i.writeFileToAsync(d, w, p, v, T);
        }, g);
      });
    },
    /**
...
async function O1(e, t) {
  try {
    ...
    const o = await I1(
      `${T1}/assets/latest/${e}/hotspot?architecture=${r}&image_type=${i}&os=${n}&vendor=eclipse`
    );
    if (!(o != null && o.length))
...
const Qr = {
  ...
  async addMicrosoft() {
    const e = await x1(), t = zr(), n = t.findIndex((r) => r.id === e.id);
    return n >= 0 ? t[n] = e : (t.length === 0 && (e.isActive = !0), t.push(e)), Hi(t), e;
  },
  remove(e) {
    const t = zr().filter((n) => n.id !== e);
    Hi(t);
  },
  setActive(e) {
    const t = zr().map((n) => ({ ...n, isActive: n.id === e }));
    Hi(t);
  },
  getActive() {
    return zr().find((e) => e.isActive) ?? null;
  },
  async refresh(e) {
    const t = zr(), n = t.find((r) => r.id === e);
    if (!n) throw new Error("Account not found");
    try {
      const r = await k1(n.refreshToken);
      Object.assign(n, r), Hi(t);
    } catch {
      n.status = "errored", Hi(t);
    }
  }
};
function Ud() {
...
}, $r = /* @__PURE__ */ new Map(), Ec = /* @__PURE__ */ new Map(), qs = /* @__PURE__ */ new Map();
function U1(e, t) {
...
function jd(e, t) {
  $e.getAllWindows().forEach((n) => n.webContents.send(e, t));
}
...
async function B1(e, t, n, r) {
  ...
  for (const T of l.libraries ?? []) {
    if (!((y = T.downloads) != null && y.artifact)) continue;
    const C = T.downloads.artifact, F = k.join(n, C.path);
  ...
  if (x.existsSync(h)) {
    const T = new pn(h), C = T.getEntries().some((q) => q.entryName.includes("UndashedUuid")), F = T.getEntries().some((q) => q.entryName.includes("GameProfile"));
    console.log("[Patched client] UndashedUuid:", C, "| GameProfile:", F), console.log("[Patched client] authlib entries:", T.getEntries().filter((q) => q.entryName.includes("mojang/authlib") || q.entryName.includes("mojang/util")).map((q) => q.entryName).slice(0, 10));
  }
  const d = new pn(k.join(n, "net/neoforged/neoforge", t, `neoforge-${t}-universal.jar`)), m = d.getEntries().filter((T) => T.entryName.startsWith("META-INF") || T.entryName.includes("authlib") || T.entryName.includes("MANIFEST"));
  console.log("[Universal JAR entries]", m.map((T) => T.entryName));
  const p = d.readAsText("META-INF/MANIFEST.MF");
  console.log("[Universal MANIFEST]", p);
  const v = new pn(s);
  for (const T of v.getEntries())
    if (console.log("[Installer entry]", T.entryName), T.entryName.includes("authlib") && T.entryName.endsWith(".jar")) {
      const C = k.join(n, T.entryName.replace("maven/", ""));
      x.existsSync(C) || (x.mkdirSync(k.dirname(C), { recursive: !0 }), v.extractEntryTo(T, k.dirname(C), !1, !0)), f.includes(C) || f.unshift(C);
      break;
    }
  return {
    mainClass: l.mainClass ?? "net.neoforged.fml.startup.Client",
    gameArgs: (((g = l.arguments) == null ? void 0 : g.game) ?? []).filter((T) => typeof T == "string"),
    jvmArgs: (((w = l.arguments) == null ? void 0 : w.jvm) ?? []).filter((T) => typeof T == "string"),
    neoClasspath: f
  };
}
async function H1(e, t, n, r, i) {
  ...
  return console.log("[Forge versionProfile libs]", JSON.stringify((y = v.libraries) == null ? void 0 : y.slice(0, 3), null, 2)), {
    ...
    jvmArgs: (((T = v.arguments) == null ? void 0 : T.jvm) ?? []).filter((C) => typeof C == "string")
  };
}
function q1() {
...
async function z1(e) {
  var U, I, me, be, Ae, xe, ke, Ze, Oe;
  if ($r.has(e)) throw new Error("Instance is already running!");
  const t = k.join(oe.instances, e), n = k.join(t, "instance.json");
  if (!x.existsSync(n)) throw new Error("Instance not found");
  const r = JSON.parse(x.readFileSync(n, "utf-8")), i = k.join(t, "minecraft"), o = fn.store, s = Qr.getActive();
  if (!s) throw new Error("No active account. Please log in first.");
  hs(e, "downloading"), Ne(e, "🌿 Fernlaunch starting..."), Ne(e, `Launching ${r.name} (${r.version})`), Ne(e, "Fetching version manifest...");
  ...
  for (const X of u.libraries) {
    if (X.rules && !X.rules.every((Ce) => {
      var Qe;
      const ft = (Qe = Ce.os) == null ? void 0 : Qe.name;
  ...
  function y(X) {
    try {
      ...
      if (!Ee) return 0;
      const _e = Ee[1];
      return _e.startsWith("1.") ? parseInt(_e.split(".")[1]) : parseInt(_e.split(".")[0]);
    } catch {
      return 0;
    }
  }
  ...
  if (r.modLoader === "fabric" && r.modLoaderVersion)
    ...
    w = X.mainClass, T = X.gameArgs, C = X.jvmArgs, F = X.neoClasspath, Ne(e, `NeoForge main class: ${w}`);
  ...
  for (let X = 0; X < G.length; X += Y)
    await Promise.all(G.slice(X, X + Y).map(async ([, ve]) => {
      const Ee = ve.hash, _e = Ee.substring(0, 2), Ce = k.join(Z, _e, Ee);
      x.existsSync(Ce) || await Bt(`https://resources.download.minecraft.net/${_e}/${Ee}`, Ce), z++;
  ...
  if (x.mkdirSync(J, { recursive: !0 }), x.mkdirSync(i, { recursive: !0 }), parseInt(r.version.split(".")[1] ?? "0") <= 12) {
    ...
    for (const ve of u.libraries) {
      if (!((me = ve.natives) != null && me[X]) || ve.rules && !ve.rules.every((Qe) => {
        var Ri;
        const dt = (Ri = Qe.os) == null ? void 0 : Ri.name;
        return dt ? Qe.action === "allow" ? dt === X : dt !== X : Qe.action === "allow";
      }))
        continue;
      const Ee = ve.natives[X].replace("${arch}", "64"), _e = (Ae = (be = ve.downloads) == null ? void 0 : be.classifiers) == null ? void 0 : Ae[Ee];
      if (!_e) continue;
      const Ce = k.join(h, _e.path);
      if (await Bt(_e.url, Ce), x.existsSync(Ce)) {
        const ft = new pn(Ce);
        ft.getEntries().forEach((Qe) => {
          !Qe.isDirectory && (Qe.entryName.endsWith(".dll") || Qe.entryName.endsWith(".so") || Qe.entryName.endsWith(".dylib")) && ft.extractEntryTo(Qe, J, !1, !0);
        }), console.log("[Natives] Extracted from", _e.path);
      }
    }
  ...
  if ((xe = u.arguments) != null && xe.jvm)
    for (const X of u.arguments.jvm)
      typeof X == "string" ? A.push(X) : X.rules && X.rules.every((Ee) => {
        var Ce;
        const _e = (Ce = Ee.os) == null ? void 0 : Ce.name;
        return _e ? Ee.action === "allow" ? _e === m : _e !== m : Ee.action === "allow";
      }) && A.push(...Array.isArray(X.value) ? X.value : [X.value]);
  else
    A.push(`-Djava.library.path=${J}`, "-cp", R);
  const M = [];
  if ((ke = u.arguments) != null && ke.game)
  ...
  const re = [
    ...
    ...q.length > 0 && q.includes("--tweakClass") ? qi(q, $) : [...qi(M, $), ...T, ...q],
    ...Re
  ];
  ...
  $r.set(e, E), (Ze = E.stdout) == null || Ze.on("data", (X) => {
    X.toString().split(`
...
`).filter((ve) => ve.trim()).forEach((ve) => Ne(e, ve));
    ...
    Ec.set(e, Date.now()), hs(e, "running"), Ne(e, "✓ Minecraft process started"), o.minecraft.hideOnLaunch && $e.getAllWindows().filter((X) => !X.webContents.getURL().includes("console")).forEach((X) => X.hide());
  }), E.on("close", (X) => {
    var ve;
    if ($r.delete(e), o.minecraft.recordPlayTime) {
      const Ee = Date.now(), _e = Ec.get(e);
      if (_e) {
        const Ce = Math.floor((Ee - _e) / 1e3);
        Vt.updatePlayTime(e, Ce);
      }
    }
    if (Ec.delete(e), o.minecraft.hideOnLaunch && $e.getAllWindows().filter((Ee) => !Ee.webContents.getURL().includes("console")).forEach((Ee) => Ee.show()), o.minecraft.hideConsoleOnExit && X === 0 && ((ve = $e.getAllWindows().find((Ee) => Ee.webContents.getURL().includes("console"))) == null || ve.hide()), o.minecraft.quitOnClose) {
      tt.quit();
      return;
    }
    if (X !== 0 && o.minecraft.showConsoleOnCrash) {
      const Ee = $e.getAllWindows().find((_e) => _e.webContents.getURL().includes(`instanceId=${e}`));
      Ee ? Ee.show() : jd("open-console", { instanceId: e });
    }
    jd("instances:updated", {});
  }), E.on("error", (X) => {
    $r.delete(e), hs(e, "crashed"), Ne(e, `Failed to start: ${X.message}`);
  });
}
function V1(e) {
  const t = $r.get(e);
...
function K1() {
  ie.handle("instances:get", () => Vt.getAll()), ie.handle("instances:create", (e, t) => {
    const n = Vt.create(t);
    return $e.getAllWindows().forEach((r) => r.webContents.send("instances:updated")), n;
  }), ie.handle("instances:delete", (e, t) => {
    Vt.delete(t), $e.getAllWindows().forEach((n) => n.webContents.send("instances:updated"));
  }), ie.handle("instances:copy", (e, t) => {
    const n = Vt.copy(t);
    return $e.getAllWindows().forEach((r) => r.webContents.send("instances:updated")), n;
  }), ie.handle("instances:update", (e, t) => {
    Vt.update(t), $e.getAllWindows().forEach((n) => n.webContents.send("instances:updated"));
    ...
    return hr(`https://api.curseforge.com/v1/mods/search?${a}`, s);
    ...
    return hr(`https://api.curseforge.com/v1/mods/${t}/files?${o}`, i);
    ...
    if (!n) return;
    const { filePath: r } = await Yr.showSaveDialog({
      title: "Create Shortcut",
      defaultPath: k.join(tt.getPath("desktop"), `${n.name}.lnk`),
      filters: [{ name: "Shortcut", extensions: ["lnk"] }]
    });
    r && (tt.isPackaged ? Ki.writeShortcutLink(r, {
      target: process.execPath,
      description: `Launch ${n.name} via Fernlaunch`
    }) : Yr.showMessageBox({
      type: "info",
    ...
    x.mkdirSync(s, { recursive: !0 }), n.extractAllTo(s, !0), x.writeFileSync(k.join(s, "instance.json"), JSON.stringify(i, null, 2)), $e.getAllWindows().forEach((a) => a.webContents.send("instances:updated"));
  }), ie.handle("dialog:openFile", async (e, t) => Yr.showOpenDialog(t)), ie.handle("instance:setIcon", async (e, t) => {
    const { filePaths: n } = await Yr.showOpenDialog({
    ...
    return s && (s.icon = `icon${r}`, Vt.update(s), $e.getAllWindows().forEach((a) => a.webContents.send("instances:updated"))), o;
    ...
    var F, q;
    const i = await import("https"), o = $e.fromWebContents(e.sender), s = (K) => o == null ? void 0 : o.webContents.send("modpack:progress", K);
    ...
    const h = f.dependencies.minecraft, d = f.dependencies["fabric-loader"], m = f.dependencies["quilt-loader"], p = f.dependencies.forge, v = f.dependencies.neoforge, y = d ? "fabric" : m ? "quilt" : p ? "forge" : v ? "neoforge" : "none", g = d ?? m ?? p ?? v ?? "", w = Vt.create({
      ...
      group: r,
      icon: "default"
    }), T = k.join(oe.instances, w.id, "minecraft", "mods");
    ...
    return x.unlinkSync(u), $e.getAllWindows().forEach((K) => K.webContents.send("instances:updated")), { instance: w, manualFiles: C };
    ...
    return i;
  }), ie.handle("get:downloadsPath", () => tt.getPath("downloads")), ie.handle("instance:installCurseForgeModpack", async (e, t, n, r, i) => {
    var C, F, q, K, H;
    const o = $e.fromWebContents(e.sender), s = (S) => o == null ? void 0 : o.webContents.send("modpack:progress", S);
    s("Fetching modpack info...");
    const a = fn.store.services.curseforgeApiKey, u = (await hr(`https://api.curseforge.com/v1/mods/${n}/files/${t}`, a)).data;
    s("Downloading modpack...");
      ...
      if (S.required !== !1) {
        ...
        try {
          ...
          if (V.downloadUrl)
            ...
            try {
              const G = `https://www.curseforge.com/minecraft/mc-mods/${((H = (await hr(`https://api.curseforge.com/v1/mods/${S.projectID}`, a)).data) == null ? void 0 : H.slug) ?? String(S.projectID)}/files/${S.fileID}`;
    ...
    return $e.getAllWindows().forEach((S) => S.webContents.send("instances:updated")), { instance: y, manualFiles: w };
    ...
    return hr(`https://api.curseforge.com/v1/mods/search?${i}`, r);
    ...
    return hr(`https://api.curseforge.com/v1/mods/${t}/files?${r}`, n);
  });
}
function J1() {
  ie.handle("accounts:get", () => Qr.getAll()), ie.handle("accounts:addMicrosoft", async () => {
    const e = await Qr.addMicrosoft();
    return $e.getAllWindows().forEach((t) => {
      t.webContents.send("accounts:updated");
    }), e;
  }), ie.handle("accounts:remove", (e, t) => {
    Qr.remove(t), $e.getAllWindows().forEach((n) => {
      n.webContents.send("accounts:updated");
    });
  }), ie.handle("accounts:setActive", (e, t) => {
    Qr.setActive(t), $e.getAllWindows().forEach((n) => {
      n.webContents.send("accounts:updated");
    });
  }), ie.handle("accounts:refresh", (e, t) => Qr.refresh(t));
}
...
function X1() {
  ie.handle("java:detect", async () => new Promise((e) => {
    ...
    const e = new $e({
      ...
      center: !0,
      webPreferences: {
        preload: ct(Hd, "../dist-electron/preload.cjs"),
        sandbox: !1
      }
    });
    e.setMenuBarVisibility(!1), qd ? e.loadURL(qd + "?window=javaDownload") : e.loadFile(ct(Hd, "../../dist/index.html"), {
      query: { window: "javaDownload" }
    });
  }), ie.handle("java:browse", async () => {
    const e = await Yr.showOpenDialog({
    ...
    for (const [h, d] of u) {
      ...
      try {
        await new Promise((y, g) => {
          const w = x.createWriteStream(m), T = _t.get(p.url, (C) => {
            if (C.statusCode !== 200) {
              w.close(), x.unlink(m, () => {
          ...
          T.on("error", (C) => {
            ...
            T.destroy(), g(new Error(`Timeout downloading ${h}`));
          });
        });
      } catch (y) {
        console.error(`Failed to download ${h}:`, y);
      }
      l++, $e.getAllWindows().forEach((y) => {
...
var He = x, cI = tI, lI = rI, uI = oI, ps = bl, lt, Vs;
...
var Nr = fI;
ps.debuglog ? Nr = ps.debuglog("gfs4") : /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && (Nr = function() {
...
if (!He[lt]) {
  ...
  og(He, dI), He.close = function(e) {
    ...
    function t(n) {
      e.apply(He, arguments), Gd();
    }
    return Object.defineProperty(t, Vs, {
      value: e
    }), t;
  }(He.closeSync), /\bgfs4\b/i.test(process.env.NODE_DEBUG || "") && process.on("exit", function() {
    Nr(He[lt]), bp.equal(He[lt].length, 0);
  });
}
Ct[lt] || og(Ct, He[lt]);
var Rt = xu(uI(He));
process.env.TEST_GRACEFUL_FS_GLOBAL_PATCH && !He.__patched && (Rt = xu(He), He.__patched = !0);
function xu(e) {
  ...
  function n(H, S, j) {
    ...
    function V(Z, D, L, G) {
      return t(Z, D, function(z) {
        z && (z.code === "EMFILE" || z.code === "ENFILE") ? Vr([V, [Z, D, L], z, G || Date.now(), Date.now()]) : typeof L == "function" && L.apply(this, arguments);
      });
    }
  }
  var r = e.writeFile;
  ...
  function i(H, S, j, V) {
    ...
    function Z(D, L, G, z, Y) {
      return r(D, L, G, function(J) {
        J && (J.code === "EMFILE" || J.code === "ENFILE") ? Vr([Z, [D, L, G, z], J, Y || Date.now(), Date.now()]) : typeof z == "function" && z.apply(this, arguments);
      });
    }
  }
  var o = e.appendFile;
  ...
  function f(H, S, j) {
    ...
    function Z(D, L, G, z) {
      return function(Y, J) {
        Y && (Y.code === "EMFILE" || Y.code === "ENFILE") ? Vr([
          V,
          [D, L, G],
          Y,
          z || Date.now(),
  ...
  var m = e.WriteStream;
  m && (w.prototype = Object.create(m.prototype), w.prototype.open = T), Object.defineProperty(e, "ReadStream", {
    get: function() {
      return y;
    },
    set: function(H) {
...
function Vr(e) {
  Nr("ENQUEUE", e[0].name, e[1]), He[lt].push(e), ku();
}
var ms;
function Gd() {
  for (var e = Date.now(), t = 0; t < He[lt].length; ++t)
    He[lt][t].length > 2 && (He[lt][t][3] = e, He[lt][t][4] = e);
  ku();
}
function ku() {
  if (clearTimeout(ms), ms = void 0, He[lt].length !== 0) {
    var e = He[lt].shift(), t = e[0], n = e[1], r = e[2], i = e[3], o = e[4];
    if (i === void 0)
      ...
      a >= u ? (Nr("RETRY", t.name, n), t.apply(null, n.concat([i]))) : He[lt].push(e);
    }
...
const ag = xr, { checkPath: cg } = sg, lg = (e) => {
  const t = { mode: 511 };
...
function EI(e, t, n) {
  const r = di.openSync(e, "r+");
  return di.futimesSync(r, t, n), di.closeSync(r);
}
var fg = {
  utimesMillis: vI,
  utimesMillisSync: EI
};
const gi = xr, nt = k, _I = bl;
function wI(e, t, n) {
  const r = n.dereference ? (i) => gi.stat(i, { bigint: !0 }) : (i) => gi.lstat(i, { bigint: !0 });
  return Promise.all([
    r(e),
    r(t).catch((i) => {
...
function $I(e, t, n) {
  let r;
  const i = n.dereference ? (s) => gi.statSync(s, { bigint: !0 }) : (s) => gi.lstatSync(s, { bigint: !0 }), o = i(e);
  try {
    r = i(t);
  } catch (s) {
...
function SI(e, t, n, r, i) {
  _I.callbackify(wI)(e, t, r, (o, s) => {
    ...
    if (c) {
      if (Do(a, c)) {
        const u = nt.basename(e), l = nt.basename(t);
...
function bI(e, t, n, r) {
  ...
  if (o) {
    if (Do(i, o)) {
      const s = nt.basename(e), a = nt.basename(t);
...
function dg(e, t, n, r, i) {
  const o = nt.resolve(nt.dirname(e)), s = nt.resolve(nt.dirname(n));
  if (s === o || s === nt.parse(s).root) return i();
  gi.stat(s, { bigint: !0 }, (a, c) => a ? a.code === "ENOENT" ? i() : i(a) : Do(t, c) ? i(new Error(Na(e, n, r))) : dg(e, t, s, r, i));
}
function hg(e, t, n, r) {
  const i = nt.resolve(nt.dirname(e)), o = nt.resolve(nt.dirname(n));
  if (o === i || o === nt.parse(o).root) return;
  let s;
  try {
    s = gi.statSync(o, { bigint: !0 });
  } catch (a) {
...
function ju(e, t) {
  const n = nt.resolve(e).split(nt.sep).filter((i) => i), r = nt.resolve(t).split(nt.sep).filter((i) => i);
...
const kt = Rt, uo = k, TI = gn.mkdirs, AI = kr.pathExists, CI = fg.utimesMillis, fo = Ni;
function NI(e, t, n, r) {
...
var BI = NI;
const Et = Rt, ho = k, HI = gn.mkdirsSync, qI = fg.utimesMillisSync, po = Ni;
function zI(e, t, n) {
...
const dP = Ot.fromPromise, Tg = xr, Ag = k, Cg = gn, Ng = Pa, Qd = dP(async function(t) {
  let n;
  try {
    n = await Tg.readdir(t);
  } catch {
    return Cg.mkdirs(t);
  }
  return Promise.all(n.map((r) => Ng.remove(Ag.join(t, r))));
});
function eh(e) {
  let t;
  try {
...
const vP = Ot.fromCallback, Og = k, zn = Rt, Rg = gn, EP = kr.pathExists, { areIdentical: Dg } = Ni;
function _P(e, t, n) {
  function r(i, o) {
    zn.link(i, o, (s) => {
      if (s) return n(s);
...
const Jn = k, io = Rt, SP = kr.pathExists;
function bP(e, t, n) {
  if (Jn.isAbsolute(e))
...
const PP = Ot.fromCallback, Lg = k, tn = xr, xg = gn, OP = xg.mkdirs, RP = xg.mkdirsSync, kg = AP, DP = kg.symlinkPaths, FP = kg.symlinkPathsSync, Ug = IP, LP = Ug.symlinkType, xP = Ug.symlinkTypeSync, kP = kr.pathExists, { areIdentical: jg } = Ni;
function UP(e, t, n, r) {
...
async function zP(e, t = {}) {
  ...
  const n = t.fs || yi, r = "throws" in t ? t.throws : !0;
...
const ZP = Ot.fromCallback, oo = Rt, Hg = k, qg = gn, QP = kr.pathExists;
function eO(e, t, n, r) {
...
var fO = It;
const dO = Rt, cl = k, hO = Bu.copy, zg = Pa.remove, pO = gn.mkdirp, mO = kr.pathExists, ch = Ni;
function gO(e, t, n, r) {
...
var EO = gO;
const Vg = Rt, ll = k, _O = Bu.copySync, Gg = Pa.removeSync, wO = gn.mkdirpSync, uh = Ni;
function $O(e, t, n) {
  n = n || {};
...
var Nt = {}, fl = { exports: {} }, ys = { exports: {} }, Tc, fh;
function RO() {
  if (fh) return Tc;
  fh = 1;
  ...
  function e(t) {
    ...
    function r(f) {
      ...
      function v(...y) {
        if (!v.enabled)
          return;
        const g = v, w = Number(/* @__PURE__ */ new Date()), T = w - (h || w);
        g.diff = T, g.prev = h, g.curr = w, h = w, y[0] = r.coerce(y[0]), typeof y[0] != "string" && y.unshift("%O");
        let C = 0;
...
function LO() {
  if (mh) return Nc;
  mh = 1;
  const e = ia, t = Ap, n = FO(), { env: r } = process;
  let i;
...
const MO = _i, BO = kO, HO = x, qO = Co, dl = rr, zO = Qn, yh = Ii, VO = Fo, pr = (0, BO.default)("electron-builder");
...
class oi {
  ...
  doApiRequest(t, n, r, i = 0) {
    return pr.enabled && pr(`Request: ${Js(t)}`), n.createPromise((o, s, a) => {
  ...
  handleResponse(t, n, r, i, o, s, a) {
    var c;
    if (pr.enabled && pr(`Response: ${t.statusCode} ${t.statusMessage}, request options: ${Js(n)}`), t.statusCode === 404) {
...
`));
    ...
    const u = (c = t.statusCode) !== null && c !== void 0 ? c : 0, l = u >= 300 && u < 400, f = hi(t, "location");
    if (l && f != null) {
      if (s > this.maxRedirects) {
        o(this.createMaxRedirectError());
        return;
      }
      this.doApiRequest(oi.prepareRedirectUrlOptions(f, n), r, a, s).then(i).catch(o);
      return;
    }
    t.setEncoding("utf8");
    let h = "";
    t.on("error", o), t.on("data", (d) => h += d), t.on("end", () => {
      try {
        if (t.statusCode != null && t.statusCode >= 400) {
          const d = hi(t, "content-type"), m = d != null && (Array.isArray(d) ? d.find((p) => p.includes("json")) != null : d.includes("json"));
          o(hl(t, `method: ${n.method || "GET"} url: ${n.protocol || "https:"}//${n.hostname}${n.port ? `:${n.port}` : ""}${n.path}
  ...
  doDownload(t, n, r) {
    const i = this.createRequest(t, (o) => {
      ...
      const s = hi(o, "location");
      if (s != null) {
        r < this.maxRedirects ? this.doDownload(oi.prepareRedirectUrlOptions(s, t), n, r++) : n.callback(this.createMaxRedirectError());
        return;
      }
  ...
  static prepareRedirectUrlOptions(t, n) {
    ...
    if (i != null && i.authorization) {
      const o = oi.reconstructOriginalUrl(n), s = Kg(t, n);
      oi.isCrossOriginRedirect(o, s) && (pr.enabled && pr(`Given the cross-origin redirect (from ${o.host} to ${s.host}), the Authorization header will be stripped out.`), delete i.authorization);
    }
    return r;
  }
...
function JO(e, t) {
  if (!KO(hi(t, "X-Checksum-Sha2"), e.options.sha2, e.callback))
    return;
  const n = [];
  if (e.options.onProgress != null) {
    const s = hi(t, "content-length");
...
const Qg = _i, ey = Ii, iR = "options.name must be either a string or a Buffer", vh = (0, Qg.randomBytes)(16);
vh[0] = vh[0] | 1;
const xs = {}, we = [];
for (let e = 0; e < 256; e++) {
...
vi.UUID = Dr;
Dr.OID = Dr.parse("6ba7b812-9dad-11d1-80b4-00c04fd430c8");
function Eh(e) {
  switch (e) {
    case 0:
    case 1:
...
function oR(e, t, n, r, i = so.ASCII) {
  ...
  switch (i) {
    case so.BINARY:
      ...
      break;
    case so.OBJECT:
      a[6] = a[6] & 15 | n, a[8] = a[8] & 63 | 128, c = new Dr(a);
      break;
    default:
      c = we[a[0]] + we[a[1]] + we[a[2]] + we[a[3]] + "-" + we[a[4]] + we[a[5]] + "-" + we[a[6] & 15 | n] + we[a[7]] + "-" + we[a[8] & 63 | 128] + we[a[9]] + "-" + we[a[10]] + we[a[11]] + we[a[12]] + we[a[13]] + we[a[14]] + we[a[15]];
      break;
  }
  return c;
}
function sR(e) {
  return we[e[0]] + we[e[1]] + we[e[2]] + we[e[3]] + "-" + we[e[4]] + we[e[5]] + "-" + we[e[6]] + we[e[7]] + "-" + we[e[8]] + we[e[9]] + "-" + we[e[10]] + we[e[11]] + we[e[12]] + we[e[13]] + we[e[14]] + we[e[15]];
}
vi.nil = new Dr("00000000-0000-0000-0000-000000000000");
var xo = {}, ty = {};
(function(e) {
  (function(t) {
    ...
    function i(_) {
      ...
      var Ae = t.MAX_BUFFER_LENGTH - U;
      _.bufferCheckPosition = Ae + _.position;
    }
    function o(_) {
    ...
    var h = "[CDATA[", d = "DOCTYPE", m = "http://www.w3.org/XML/1998/namespace", p = "http://www.w3.org/2000/xmlns/", v = { xml: m, xmlns: p }, y = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, g = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, w = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, T = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
    function C(_) {
      return _ === " " || _ === `
` || _ === "\r" || _ === "	";
    }
...
Actual: ` + _.attribValue
    ...
    function M(_, E) {
      if (_.opt.xmlns) {
        ...
        for (var be = 0, Ae = _.attribList.length; be < Ae; be++) {
          var xe = _.attribList[be], ke = xe[0], Ze = xe[1], Oe = $(ke, !0), X = Oe.prefix, ve = Oe.local, Ee = X === "" ? "" : U.ns[X] || "", _e = {
            name: ke,
            value: Ze,
            prefix: X,
            local: ve,
          ...
          ), _e.uri = X), _.tag.attributes[ke] = _e, z(_, "onattribute", _e);
        }
    ...
    function re(_) {
      ...
      for (var be = _.tags.length; be-- > E; ) {
        var Ae = _.tag = _.tags.pop();
        _.tagName = _.tag.name, z(_, "onclosetag", _.tagName);
        var xe = {};
        for (var ke in Ae.ns)
          xe[ke] = Ae.ns[ke];
        var Ze = _.tags[_.tags.length - 1] || _;
        _.opt.xmlns && Ae.ns !== Ze.ns && Object.keys(Ae.ns).forEach(function(Oe) {
          var X = Ae.ns[Oe];
...
` ? (E.line++, E.column = 0) : E.column++);
          ...
          case S.PROC_INST_ENDING:
            if (I === ">") {
              ...
              G(E, Ze), z(E, "onprocessinginstruction", Ze), E.procInstName = E.procInstBody = "", E.state = S.TEXT;
            } else
          ...
          case S.ATTRIB:
            ...
            continue;
          case S.ATTRIB_NAME:
            I === "=" ? E.state = S.ATTRIB_VALUE : I === ">" ? (R(E, "Attribute without value"), E.attribValue = E.attribName, A(E), M(E)) : C(I) ? E.state = S.ATTRIB_NAME_SAW_WHITE : K(g, I) ? E.attribName += I : R(E, "Invalid attribute name");
            continue;
          ...
          case S.ATTRIB_VALUE_QUOTED:
            ...
            A(E), E.q = "", E.state = S.ATTRIB_VALUE_CLOSED;
            continue;
          ...
          case S.ATTRIB_VALUE_ENTITY_U:
            ...
            switch (E.state) {
              case S.TEXT_ENTITY:
                Ae = S.TEXT, xe = "textNode";
                break;
              case S.ATTRIB_VALUE_ENTITY_Q:
                Ae = S.ATTRIB_VALUE_QUOTED, xe = "attribValue";
                break;
              case S.ATTRIB_VALUE_ENTITY_U:
                Ae = S.ATTRIB_VALUE_UNQUOTED, xe = "attribValue";
                break;
            }
            if (I === ";") {
              var ke = te(E);
              E.opt.unparsedEntities && !Object.values(t.XML_ENTITIES).includes(ke) ? ((E.entityCount += 1) > E.opt.maxEntityCount && B(
                E,
                "Parsed entity count exceeds max entity count"
              ), (E.entityDepth += 1) > E.opt.maxEntityDepth && B(
                E,
                "Parsed entity depth exceeds max entity depth"
              ), E.entity = "", E.state = Ae, E.write(ke), E.entityDepth -= 1) : (E[xe] += ke, E.entity = "", E.state = Ae);
            } else K(E.entity.length ? T : w, I) ? E.entity += I : (R(E, "Invalid character in entity name"), E[xe] += "&" + E.entity + I, E.entity = "", E.state = Ae);
            continue;
          default:
    ...
    String.fromCodePoint || function() {
      var _ = String.fromCharCode, E = Math.floor, U = function() {
        var I = 16384, me = [], be, Ae, xe = -1, ke = arguments.length;
        if (!ke)
          return "";
        for (var Ze = ""; ++xe < ke; ) {
          var Oe = Number(arguments[xe]);
          ...
          Oe <= 65535 ? me.push(Oe) : (Oe -= 65536, be = (Oe >> 10) + 55296, Ae = Oe % 1024 + 56320, me.push(be, Ae)), (xe + 1 === ke || me.length > I) && (Ze += _.apply(null, me), me.length = 0);
        }
        return Ze;
      };
...
}), TR = Dt, cy = new TR("tag:yaml.org,2002:map", {
  kind: "mapping",
  construct: function(e) {
    return e !== null ? e : {};
  }
...
}), wr = sn, Ty = ko, _D = yR, wD = Xu, er = Object.prototype.hasOwnProperty, Ys = 1, Ay = 2, Cy = 3, Xs = 4, Rc = 1, $D = 2, Sh = 3, SD = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/, bD = /[\x85\u2028\u2029]/, TD = /[,\[\]\{\}]/, Ny = /^(?:!|!!|![a-z\-]+!)$/i, Iy = /^(?:!|[^,\[\]\{\}])(?:%[0-9a-f]{2}|[0-9a-z\-#;\/\?:@&=\+\$,_\.!~\*'\(\)\[\]])*$/i;
function bh(e) {
...
function Dy(e, t) {
  ...
  return n.snippet = _D(n), new Ty(t, n);
}
function ae(e, t) {
  throw Dy(e, t);
}
...
function Ch(e, t, n, r) {
  var i, o, s, a;
  for (wr.isObject(n) || ae(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(n), s = 0, a = i.length; s < a; s += 1)
    o = i[s], er.call(t, o) || (Py(t, o, n[o]), r[o] = !0);
}
function ai(e, t, n, r, i, o, s, a, c) {
  var u, l;
  if (Array.isArray(i))
...
function OD(e, t, n) {
  ...
  if (d = e.input.charCodeAt(e.position), Ut(d) || si(d) || d === 35 || d === 38 || d === 42 || d === 33 || d === 124 || d === 62 || d === 39 || d === 34 || d === 37 || d === 64 || d === 96 || (d === 63 || d === 45) && (i = e.input.charCodeAt(e.position + 1), Ut(i) || n && si(i)))
    return !1;
  for (e.kind = "scalar", e.result = "", o = s = e.position, a = !1; d !== 0; ) {
    if (d === 58) {
      if (i = e.input.charCodeAt(e.position + 1), Ut(i) || n && si(i))
        break;
    } else if (d === 35) {
      if (r = e.input.charCodeAt(e.position - 1), Ut(r))
        break;
    } else {
      if (e.position === e.lineStart && Da(e) || n && si(d))
        break;
      if (mn(d))
        if (c = e.line, u = e.lineStart, l = e.lineIndent, We(e, !1, -1), e.lineIndent >= t) {
    ...
    a && (Xn(e, o, s, !1), Qu(e, e.line - c), o = s = e.position, a = !1), Ir(d) || (s = e.position + 1), d = e.input.charCodeAt(++e.position);
  }
  ...
  for (e.kind = "scalar", e.result = "", e.position++, r = i = e.position; (n = e.input.charCodeAt(e.position)) !== 0; )
    if (n === 39)
      if (Xn(e, r, e.position, !0), n = e.input.charCodeAt(++e.position), n === 39)
        ...
        return !0;
    else mn(n) ? (Xn(e, r, i, !0), Qu(e, We(e, !1, t)), r = i = e.position) : e.position === e.lineStart && Da(e) ? ae(e, "unexpected end of the document within a single quoted scalar") : (e.position++, i = e.position);
  ...
  for (e.kind = "scalar", e.result = "", e.position++, n = r = e.position; (a = e.input.charCodeAt(e.position)) !== 0; ) {
    ...
    if (a === 92) {
      if (Xn(e, n, e.position, !0), a = e.input.charCodeAt(++e.position), mn(a))
        ...
        for (i = s, o = 0; i > 0; i--)
          a = e.input.charCodeAt(++e.position), (s = AD(a)) >= 0 ? o = (o << 4) + s : ae(e, "expected hexadecimal character");
        e.result += ID(o), e.position++;
      } else
        ae(e, "unknown escape sequence");
      n = r = e.position;
    } else mn(a) ? (Xn(e, n, r, !0), Qu(e, We(e, !1, t)), n = r = e.position) : e.position === e.lineStart && Da(e) ? ae(e, "unexpected end of the document within a double quoted scalar") : (e.position++, r = e.position);
  }
...
function FD(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = a), g = e.input.charCodeAt(++e.position); g !== 0; ) {
    if (We(e, !0, t), g = e.input.charCodeAt(e.position), g === l)
      return e.position++, e.tag = s, e.anchor = c, e.kind = d ? "mapping" : "sequence", e.result = a, !0;
    n ? g === 44 && ae(e, "expected the node content, but found ','") : ae(e, "missed comma between flow collection entries"), v = p = y = null, f = h = !1, g === 63 && (u = e.input.charCodeAt(e.position + 1), Ut(u) && (f = h = !0, e.position++, We(e, !0, t))), r = e.line, i = e.lineStart, o = e.position, Ei(e, t, Ys, !1, !0), v = e.tag, p = e.result, We(e, !0, t), g = e.input.charCodeAt(e.position), (h || e.line === r) && g === 58 && (f = !0, g = e.input.charCodeAt(++e.position), We(e, !0, t), Ei(e, t, Ys, !1, !0), y = e.result), d ? ai(e, a, m, v, p, y, r, i, o) : f ? a.push(ai(e, null, m, v, p, y, r, i, o)) : a.push(p), We(e, !0, t), g = e.input.charCodeAt(e.position), g === 44 ? (n = !0, g = e.input.charCodeAt(++e.position)) : n = !1;
  }
...
function LD(e, t) {
  ...
  for (; f !== 0; ) {
    ...
    if (e.lineIndent < a) {
      i === Sh ? e.result += wr.repeat(`
`, o ? 1 + c : c) : i === Rc && o && (e.result += `
`);
      break;
    }
    for (r ? Ir(f) ? (u = !0, e.result += wr.repeat(`
`, o ? 1 + c : c)) : u ? (u = !1, e.result += wr.repeat(`
...
function Nh(e, t) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = o), c = e.input.charCodeAt(e.position); c !== 0 && (e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, ae(e, "tab characters must not be used in indentation")), !(c !== 45 || (s = e.input.charCodeAt(e.position + 1), !Ut(s)))); ) {
    ...
    if (n = e.line, Ei(e, t, Cy, !1, !0), o.push(e.result), We(e, !0, -1), c = e.input.charCodeAt(e.position), (e.line === n || e.lineIndent > t) && c !== 0)
...
function xD(e, t, n) {
  ...
  for (e.anchor !== null && (e.anchorMap[e.anchor] = f), g = e.input.charCodeAt(e.position); g !== 0; ) {
    if (!v && e.firstTabInLine !== -1 && (e.position = e.firstTabInLine, ae(e, "tab characters must not be used in indentation")), r = e.input.charCodeAt(e.position + 1), o = e.line, (g === 63 || g === 58) && Ut(r))
      g === 63 ? (v && (ai(e, f, h, d, m, null, s, a, c), d = m = p = null), y = !0, v = !0, i = !0) : v ? (v = !1, i = !0) : ae(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, g = r;
    else {
      if (s = e.line, a = e.lineStart, c = e.position, !Ei(e, n, Ay, !1, !0))
        break;
      if (e.line === o) {
        for (g = e.input.charCodeAt(e.position); Ir(g); )
          g = e.input.charCodeAt(++e.position);
        if (g === 58)
          g = e.input.charCodeAt(++e.position), Ut(g) || ae(e, "a whitespace character is expected after the key-value separator within a block mapping"), v && (ai(e, f, h, d, m, null, s, a, c), d = m = p = null), y = !0, v = !1, i = !1, d = e.tag, m = e.result;
        else if (y)
    ...
    if ((e.line === o || e.lineIndent > t) && (v && (s = e.line, a = e.lineStart, c = e.position), Ei(e, t, Xs, !0, i) && (v ? m = e.result : p = e.result), v || (ai(e, f, h, d, m, p, s, a, c), d = m = p = null), We(e, !0, -1), g = e.input.charCodeAt(e.position)), (e.line === o || e.lineIndent > t) && g !== 0)
      ae(e, "bad indentation of a mapping entry");
    else if (e.lineIndent < t)
      break;
  }
  return v && ai(e, f, h, d, m, null, s, a, c), y && (e.tag = u, e.anchor = l, e.kind = "mapping", e.result = f), y;
}
function kD(e) {
  var t, n = !1, r = !1, i, o, s;
  ...
  if (e.tag !== null && ae(e, "duplication of a tag property"), s = e.input.charCodeAt(++e.position), s === 60 ? (n = !0, s = e.input.charCodeAt(++e.position)) : s === 33 ? (r = !0, i = "!!", s = e.input.charCodeAt(++e.position)) : i = "!", t = e.position, n) {
    ...
    o = e.input.slice(t, e.position), TD.test(o) && ae(e, "tag suffix cannot contain flow indicator characters");
  }
...
function UD(e) {
  ...
  for (e.anchor !== null && ae(e, "duplication of an anchor property"), n = e.input.charCodeAt(++e.position), t = e.position; n !== 0 && !Ut(n) && !si(n); )
...
function jD(e) {
  ...
  for (r = e.input.charCodeAt(++e.position), t = e.position; r !== 0 && !Ut(r) && !si(r); )
    r = e.input.charCodeAt(++e.position);
  return e.position === t && ae(e, "name of an alias node must contain at least one character"), n = e.input.slice(t, e.position), er.call(e.anchorMap, n) || ae(e, 'unidentified alias "' + n + '"'), e.result = e.anchorMap[n], We(e, !0, -1), !0;
}
function Ei(e, t, n, r, i) {
  var o, s, a, c = 1, u = !1, l = !1, f, h, d, m, p, v;
  if (e.listener !== null && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, o = s = a = Xs === n || Cy === n, r && We(e, !0, -1) && (u = !0, e.lineIndent > t ? c = 1 : e.lineIndent === t ? c = 0 : e.lineIndent < t && (c = -1)), c === 1)
    for (; kD(e) || UD(e); )
      We(e, !0, -1) ? (u = !0, a = o, e.lineIndent > t ? c = 1 : e.lineIndent === t ? c = 0 : e.lineIndent < t && (c = -1)) : a = !1;
  if (a && (a = u || i), (c === 1 || Xs === n) && (Ys === n || Ay === n ? p = t : p = t + 1, v = e.position - e.lineStart, c === 1 ? a && (Nh(e, v) || xD(e, v, p)) || FD(e, p) ? l = !0 : (s && LD(e, p) || RD(e, p) || DD(e, p) ? l = !0 : jD(e) ? (l = !0, (e.tag !== null || e.anchor !== null) && ae(e, "alias node should not have any properties")) : OD(e, p, Ys === n) && (l = !0, e.tag === null && (e.tag = "?")), e.anchor !== null && (e.anchorMap[e.anchor] = e.result)) : c === 0 && (l = a && Nh(e, v))), e.tag === null)
...
function MD(e) {
  ...
  for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = /* @__PURE__ */ Object.create(null), e.anchorMap = /* @__PURE__ */ Object.create(null); (s = e.input.charCodeAt(e.position)) !== 0 && (We(e, !0, -1), s = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || s !== 37)); ) {
    ...
    s !== 0 && Zu(e), er.call(Ah, r) ? Ah[r](e, r, i) : Zs(e, 'unknown document directive "' + r + '"');
  }
  if (We(e, !0, -1), e.lineIndent === 0 && e.input.charCodeAt(e.position) === 45 && e.input.charCodeAt(e.position + 1) === 45 && e.input.charCodeAt(e.position + 2) === 45 ? (e.position += 3, We(e, !0, -1)) : o && ae(e, "directives end mark is expected"), Ei(e, e.lineIndent - 1, Xs, !1, !0), We(e, !0, -1), e.checkLineBreaks && bD.test(e.input.slice(t, e.position)) && Zs(e, "non-ASCII line breaks are interpreted as content"), e.documents.push(e.result), e.position === e.lineStart && Da(e)) {
...
function HD(e, t) {
  ...
  if (n.length !== 0) {
    if (n.length === 1)
      return n[0];
    throw new Ty("expected a single document in the stream, but found more");
  }
}
Ju.loadAll = BD;
Ju.load = HD;
...
function mF(e, t, n, r, i, o, s, a) {
  ...
  return !f && !h ? p && !s && !i(e) ? zy : o === vo ? ti : vl : n > 9 && qy(e) ? ti : s ? o === vo ? ti : vl : h ? Gy : Vy;
}
...
ta.exports;
(function(e, t) {
  var n = 200, r = "__lodash_hash_undefined__", i = 1, o = 2, s = 9007199254740991, a = "[object Arguments]", c = "[object Array]", u = "[object AsyncFunction]", l = "[object Boolean]", f = "[object Date]", h = "[object Error]", d = "[object Function]", m = "[object GeneratorFunction]", p = "[object Map]", v = "[object Number]", y = "[object Null]", g = "[object Object]", w = "[object Promise]", T = "[object Proxy]", C = "[object RegExp]", F = "[object Set]", q = "[object String]", K = "[object Symbol]", H = "[object Undefined]", S = "[object WeakMap]", j = "[object ArrayBuffer]", V = "[object DataView]", Z = "[object Float32Array]", D = "[object Float64Array]", L = "[object Int8Array]", G = "[object Int16Array]", z = "[object Int32Array]", Y = "[object Uint8Array]", J = "[object Uint8ClampedArray]", B = "[object Uint16Array]", N = "[object Uint32Array]", R = /[\\^$.*+?()[\]{}|]/g, O = /^\[object .+?Constructor\]$/, $ = /^(?:0|[1-9]\d*)$/, A = {};
  A[Z] = A[D] = A[L] = A[G] = A[z] = A[Y] = A[J] = A[B] = A[N] = !0, A[a] = A[c] = A[j] = A[l] = A[V] = A[f] = A[h] = A[d] = A[p] = A[v] = A[g] = A[C] = A[F] = A[q] = A[S] = !1;
  ...
  var Ee = Array.prototype, _e = Function.prototype, Ce = Object.prototype, ft = te["__core-js_shared__"], Qe = _e.toString, dt = Ce.hasOwnProperty, Ri = function() {
    var b = /[^.]+$/.exec(ft && ft.keys && ft.keys.IE_PROTO || "");
    return b ? "Symbol(src)_1." + b : "";
  }(), lf = Ce.toString, a0 = RegExp(
    "^" + Qe.call(dt).replace(R, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), uf = Re ? te.Buffer : void 0, qo = te.Symbol, ff = te.Uint8Array, df = Ce.propertyIsEnumerable, c0 = Ee.splice, sr = qo ? qo.toStringTag : void 0, hf = Object.getOwnPropertySymbols, l0 = uf ? uf.isBuffer : void 0, u0 = X(Object.keys, Object), Va = Mr(te, "DataView"), Di = Mr(te, "Map"), Ga = Mr(te, "Promise"), Wa = Mr(te, "Set"), Ka = Mr(te, "WeakMap"), Fi = Mr(Object, "create"), f0 = lr(Va), d0 = lr(Di), h0 = lr(Ga), p0 = lr(Wa), m0 = lr(Ka), pf = qo ? qo.prototype : void 0, Ja = pf ? pf.valueOf : void 0;
  function ar(b) {
  ...
  function E0(b) {
    var P = this.__data__;
    return Fi ? P[b] !== void 0 : dt.call(P, b);
  }
  function _0(b, P) {
    var W = this.__data__;
    return this.size += this.has(b) ? 0 : 1, W[b] = Fi && P === void 0 ? r : P, this;
  }
  ...
  yn.prototype.clear = w0, yn.prototype.delete = $0, yn.prototype.get = S0, yn.prototype.has = b0, yn.prototype.set = T0;
  function cr(b) {
    var P = -1, W = b == null ? 0 : b.length;
    for (this.clear(); ++P < W; ) {
      var ne = b[P];
  ...
  cr.prototype.clear = A0, cr.prototype.delete = C0, cr.prototype.get = N0, cr.prototype.has = I0, cr.prototype.set = P0;
  function zo(b) {
    var P = -1, W = b == null ? 0 : b.length;
  ...
  function U0(b, P) {
    var W = Wo(b), ne = !W && Q0(b), De = !W && !ne && Ya(b), de = !W && !ne && !De && Sf(b), qe = W || ne || De || de, et = qe ? Ae(b.length, String) : [], it = et.length;
    for (var Ue in b)
      dt.call(b, Ue) && !(qe && // Safari 9 has enumerable `arguments.length` in strict mode.
      (Ue == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
      De && (Ue == "offset" || Ue == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
      de && (Ue == "buffer" || Ue == "byteLength" || Ue == "byteOffset") || // Skip index properties.
      K0(Ue, it))) && et.push(Ue);
    return et;
  }
  function Vo(b, P) {
  ...
  function gf(b, P, W, ne, De) {
    return b === P ? !0 : b == null || P == null || !xi(b) && !xi(P) ? b !== b && P !== P : M0(b, P, W, ne, gf, De);
  }
  function M0(b, P, W, ne, De, de) {
    var qe = Wo(b), et = Wo(P), it = qe ? c : On(b), Ue = et ? c : On(P);
    it = it == a ? g : it, Ue = Ue == a ? g : Ue;
    var jt = it == g, Jt = Ue == g, ht = it == Ue;
    if (ht && Ya(b)) {
      if (!Ya(P))
        return !1;
      qe = !0, jt = !1;
    ...
    if (ht && !jt)
      return de || (de = new Pn()), qe || Sf(b) ? yf(b, P, W, ne, De, de) : z0(b, P, it, W, ne, De, de);
    if (!(W & i)) {
  ...
  function H0(b) {
    return xi(b) && wf(b.length) && !!A[Li(b)];
  }
  function q0(b) {
    if (!X0(b))
      return u0(b);
  ...
  function yf(b, P, W, ne, De, de) {
    var qe = W & i, et = b.length, it = P.length;
    if (et != it && !(qe && it > et))
      return !1;
    var Ue = de.get(b);
    if (Ue && de.get(P))
    ...
    for (de.set(b, P), de.set(P, b); ++jt < et; ) {
      var qt = b[jt], zt = P[jt];
      if (ne)
        var Rn = qe ? ne(zt, qt, jt, P, b, de) : ne(qt, zt, jt, b, P, de);
      if (Rn !== void 0) {
        if (Rn)
          continue;
        Jt = !1;
      ...
      if (ht) {
        if (!be(P, function(vn, ur) {
          if (!ke(ht, ur) && (qt === vn || De(qt, vn, W, ne, de)))
            return ht.push(ur);
        })) {
          Jt = !1;
          break;
  ...
  function z0(b, P, W, ne, De, de, qe) {
    switch (W) {
      ...
      case F:
        var it = ne & i;
        if (et || (et = ve), b.size != P.size && !it)
          return !1;
        var Ue = qe.get(b);
        if (Ue)
          return Ue == P;
        ne |= o, qe.set(b, P);
        var jt = yf(et(b), et(P), ne, De, de, qe);
        return qe.delete(b), jt;
      case K:
        if (Ja)
  ...
  function V0(b, P, W, ne, De, de) {
    var qe = W & i, et = vf(b), it = et.length, Ue = vf(P), jt = Ue.length;
    if (it != jt && !qe)
      return !1;
    for (var Jt = it; Jt--; ) {
      var ht = et[Jt];
      if (!(qe ? ht in P : dt.call(P, ht)))
        return !1;
    }
    var qt = de.get(b);
    if (qt && de.get(P))
    ...
    for (var Rn = qe; ++Jt < it; ) {
      ...
      var vn = b[ht], ur = P[ht];
      if (ne)
        var bf = qe ? ne(ur, vn, ht, P, b, de) : ne(vn, ur, ht, b, P, de);
  ...
  (Va && On(new Va(new ArrayBuffer(1))) != V || Di && On(new Di()) != p || Ga && On(Ga.resolve()) != w || Wa && On(new Wa()) != F || Ka && On(new Ka()) != S) && (On = function(b) {
    var P = Li(b), W = P == g ? b.constructor : void 0, ne = W ? lr(W) : "";
    if (ne)
      switch (ne) {
        case f0:
          return V;
  ...
  var Q0 = mf(/* @__PURE__ */ function() {
    ...
    return xi(b) && dt.call(b, "callee") && !df.call(b, "callee");
  }, Wo = Array.isArray;
  function ev(b) {
...
const CF = _i, NF = x, kh = AF, mr = ir, ao = k;
class IF {
  constructor(t) {
  ...
  async validateDownloadedPath(t, n, r, i) {
    if (this.versionInfo != null && this.file === t && this.fileInfo != null)
      return kh(this.versionInfo, n) && kh(this.fileInfo.info, r.info) && await (0, mr.pathExists)(t) ? t : null;
  ...
  async setDownloadedFile(t, n, r, i, o, s) {
    ...
    }, s && await (0, mr.outputJson)(this.getUpdateInfoFile(), this._downloadedFileInfo);
  }
  async clear() {
  ...
  async cleanCacheDirForPendingUpdate() {
    try {
      await (0, mr.emptyDir)(this.cacheDirForPendingUpdate);
    } catch {
    }
  }
  /**
  ...
  async getValidCachedUpdateFile(t, n) {
    ...
    if (!await (0, mr.pathExists)(r))
      return null;
    let o;
    try {
      o = await (0, mr.readJson)(r);
    } catch (u) {
...
(function(e) {
  ...
  function n() {
    return An.session.fromPartition(e.NET_SESSION_NAME, {
      cache: !1
    });
  }
...
var Ke = {}, jF = "[object Symbol]", Yy = /[\\^$.*+?()[\]{}|]/g, MF = RegExp(Yy.source), BF = typeof Ct == "object" && Ct && Ct.Object === Object && Ct, HF = typeof self == "object" && self && self.Object === Object && self, qF = BF || HF || Function("return this")(), zF = Object.prototype, VF = zF.toString, jh = qF.Symbol, Mh = jh ? jh.prototype : void 0, Bh = Mh ? Mh.toString : void 0;
function GF(e) {
  if (typeof e == "string")
    return e;
  if (KF(e))
...
Ke.Provider = void 0;
Ke.findFile = tL;
Ke.parseUpdateInfo = nL;
Ke.getFileList = Zy;
Ke.resolveFiles = rL;
const tr = Xe, XF = ut, ZF = rr, na = an, QF = Xy;
class eL {
  constructor(t) {
...
const Sn = Xe, Sr = Fu, sL = rr, ci = an, _l = Ke, Uc = /\/tag\/([^/]+)$/;
class Qy extends _l.Provider {
  constructor(t, n, r) {
    super({
      ...
      isUseMultipleRangeRequest: !1
    }), this.options = t, this.baseUrl = (0, ci.newBaseUrl)((0, Sn.githubUrl)(t, n));
    const i = n === "github.com" ? "api.github.com" : n;
    this.baseApiUrl = (0, ci.newBaseUrl)((0, Sn.githubUrl)(t, i));
  }
...
class aL extends Qy {
  ...
  async getLatestVersion() {
    var t, n, r, i, o;
    const s = new Sn.CancellationToken(), a = await this.httpRequest((0, ci.newUrlFromBase)(`${this.basePath}.atom`, this.baseUrl), {
      accept: "application/xml, application/atom+xml, text/xml, */*"
    }, s), c = (0, Sn.parseXml)(a);
    let u = c.element("entry", !1, "No published versions on GitHub"), l = null;
    try {
      if (this.updater.allowPrerelease) {
        const v = ((t = this.updater) === null || t === void 0 ? void 0 : t.channel) || ((n = Sr.prerelease(this.updater.currentVersion)) === null || n === void 0 ? void 0 : n[0]) || null;
        if (v === null)
          ...
          for (const y of c.getElements("entry")) {
            ...
            if (g === null)
              continue;
            const w = g[1], T = ((r = Sr.prerelease(w)) === null || r === void 0 ? void 0 : r[0]) || null, C = !v || ["alpha", "beta"].includes(v), F = T !== null && !["alpha", "beta"].includes(String(T));
            if (C && !F && !(v === "beta" && T === "alpha")) {
              l = w;
              break;
            }
            if (T && T === v) {
...
${a}`, "ERR_UPDATER_INVALID_RELEASE_FEED");
    ...
    let f, h = "", d = "";
    const m = async (v) => {
      h = (0, ci.getChannelFilename)(v), d = (0, ci.newUrlFromBase)(this.getBaseDownloadPath(String(l), h), this.baseUrl);
    ...
    try {
      let v = this.channel;
      this.updater.allowPrerelease && (!((i = Sr.prerelease(l)) === null || i === void 0) && i[0]) && (v = this.getCustomChannelName(String((o = Sr.prerelease(l)) === null || o === void 0 ? void 0 : o[0]))), f = await m(v);
    } catch (v) {
      if (this.updater.allowPrerelease)
  ...
  async getLatestTagName(t) {
    const n = this.options, r = n.host == null || n.host === "github.com" ? (0, ci.newUrlFromBase)(`${this.basePath}/latest`, this.baseUrl) : new sL.URL(`${this.computeGithubBasePath(`/repos/${n.owner}/${n.repo}/releases`)}/latest`, this.baseApiUrl);
    try {
...
function e0(e, t, n, r) {
  ...
  for (const o of n.getElements("entry")) {
    ...
    Sr.valid(s) && Sr.lt(e, s) && i.push({
      version: s,
      note: zh(o)
    });
  }
  return i.sort((o, s) => Sr.rcompare(o.version, s.version));
}
var ja = {};
Object.defineProperty(ja, "__esModule", { value: !0 });
ja.GitLabProvider = void 0;
const St = Xe, jc = rr, cL = Xy, _s = an, Mc = Ke;
...
const Wr = Xe, fL = ut, dL = k, Gh = rr, Wh = an, hL = nr, pL = Ke;
class mL extends hL.BaseGitHubProvider {
  ...
  async getLatestVersion() {
    const t = new Wr.CancellationToken(), n = (0, Wh.getChannelFilename)(this.getDefaultChannelName()), r = await this.getLatestVersionInfo(t), i = r.assets.find((a) => a.name === n);
    if (i == null)
      throw (0, Wr.newError)(`Cannot find ${n} in the release ${r.html_url || r.name}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND");
    const o = new Gh.URL(i.url);
    let s;
    try {
      s = (0, fL.load)(await this.httpRequest(o, this.configureHeaders("application/octet-stream"), t));
    } catch (a) {
      throw a instanceof Wr.HttpError && a.statusCode === 404 ? (0, Wr.newError)(`Cannot find ${n} in the latest release artifacts (${o}): ${a.stack || a.message}`, "ERR_UPDATER_CHANNEL_FILE_NOT_FOUND") : a;
    }
  ...
  resolveFiles(t) {
    return (0, pL.getFileList)(t).map((n) => {
      ...
      if (i == null)
        throw (0, Wr.newError)(`Cannot find asset "${r}" in: ${JSON.stringify(t.assets, null, 2)}`, "ERR_UPDATER_ASSET_NOT_FOUND");
      return {
...
ka.createClient = wL;
const ws = Xe, gL = Ua, Kh = Mo, yL = nr, vL = ja, EL = Ma, _L = Ba;
function t0(e) {
...
jr.OperationKind = void 0;
jr.computeOperations = $L;
var br;
(function(e) {
  e[e.COPY = 0] = "COPY", e[e.DOWNLOAD = 1] = "DOWNLOAD";
})(br || (jr.OperationKind = br = {}));
function $L(e, t, n) {
  ...
  for (let p = 0; p < l.checksums.length; m += l.sizes[p], p++) {
    ...
    let g = h.get(y);
    g != null && d.get(y) !== v && (n.warn(`Checksum ("${y}") matches, but size differs (old: ${d.get(y)}, new: ${v})`), g = void 0), g === void 0 ? (f++, o != null && o.kind === br.DOWNLOAD && o.end === m ? o.end += v : (o = {
      kind: br.DOWNLOAD,
      start: m,
      end: m + v
      // oldBlocks: null,
    }, Jh(o, a, y, p))) : o != null && o.kind === br.COPY && o.end === g ? o.end += v : (o = {
      kind: br.COPY,
      start: g,
      end: g + v
      // oldBlocks: [checksum]
...
function Jh(e, t, n, r) {
  if (SL && t.length !== 0) {
    ...
    if (i.kind === e.kind && e.start < i.end && e.start > i.start) {
      ...
      throw new Error(`operation (block index: ${r}, checksum: ${n}, kind: ${br[e.kind]}) overlaps previous operation (checksum: ${n}):
...
Pi.copyData = n0;
const $s = Xe, TL = x, AL = Co, CL = jr, Xh = Buffer.from(`\r
\r
`);
var Hn;
(function(e) {
...
class RL extends OL.Transform {
  constructor(t, n, r) {
    super(), this.progressDifferentialDownloadInfo = t, this.cancellationToken = n, this.onProgress = r, this.start = Date.now(), this.transferred = 0, this.delta = 0, this.expectedBytes = 0, this.index = 0, this.operationType = li.COPY, this.nextUpdate = this.start + 1e3;
  }
  _transform(t, n, r) {
    if (this.cancellationToken.cancelled) {
      r(new Error("cancelled"), null);
  ...
  beginFileCopy() {
    this.operationType = li.COPY;
  }
  beginRangeDownload() {
    this.operationType = li.DOWNLOAD, this.expectedBytes += this.progressDifferentialDownloadInfo.expectedByteCounts[this.index++];
  }
  endRangeDownload() {
...
const Gi = Xe, qc = ir, DL = x, FL = Pi, LL = rr, Ss = jr, ep = qa, xL = za;
class kL {
  ...
  async doDownloadFile(t, n) {
    ...
    await new Promise((s, a) => {
      ...
      if (!this.options.isUseMultipleRangeRequest && this.options.onProgress) {
        ...
        let g = 0;
        for (const T of t)
          T.kind === Ss.OperationKind.DOWNLOAD && (y.push(T.end - T.start), g += T.end - T.start);
        const w = {
      ...
      v.redirect = "manual", d = (y) => {
        ...
        const T = t[y++];
        if (T.kind === Ss.OperationKind.COPY) {
          u && u.beginFileCopy(), (0, FL.copyData)(T, h, r, a, () => d(y));
          return;
        }
        const C = `bytes=${T.start}-${T.end - 1}`;
...
const bt = Xe, BL = _i, HL = ia, qL = Tp, Zt = ir, zL = ut, zc = La, Qt = k, gr = Fu, np = jo, VL = xa, rp = Ky, GL = Mo, Vc = ka, Gc = Ao, WL = Ha, Kr = or;
class rf extends qL.EventEmitter {
  ...
  constructor(t, n) {
    ...
    const r = this.app.version, i = (0, gr.parse)(r);
    if (i == null)
  ...
  async isUpdateAvailable(t) {
    ...
    if ((0, gr.eq)(n, r) || !await Promise.resolve(this.isUpdateSupported(t)) || !await Promise.resolve(this.isUserWithinRollout(t)))
      return !1;
    const o = (0, gr.gt)(n, r), s = (0, gr.lt)(n, r);
  ...
  dispatchUpdateDownloaded(t) {
    this.emit(Kr.UPDATE_DOWNLOADED, t);
  }
  ...
  async executeDownload(t) {
    ...
    this.listenerCount(Kr.DOWNLOAD_PROGRESS) > 0 && (r.onProgress = (g) => this.emit(Kr.DOWNLOAD_PROGRESS, g));
  ...
  async differentialDownloadInstaller(t, n, r, i, o) {
    try {
      ...
      this.listenerCount(Kr.DOWNLOAD_PROGRESS) > 0 && (u.onProgress = (m) => this.emit(Kr.DOWNLOAD_PROGRESS, m));
      const l = async (m, p) => {
...
class YL extends JL.AppUpdater {
  ...
  quitAndInstall(t = !1, n = !1) {
    this._logger.info("Install on explicit quitAndInstall"), this.install(t, t ? n : this.autoRunAppAfterInstall) ? setImmediate(() => {
      An.autoUpdater.emit("before-quit-for-update"), this.app.quit();
...
async function ex(e) {
  const t = await (0, Jr.open)(e, "r");
  try {
    const n = (await (0, Jr.fstat)(t)).size, r = Buffer.allocUnsafe(4);
    await (0, Jr.read)(t, r, 0, r.length, n - r.length);
    const i = Buffer.allocUnsafe(r.readUInt32BE(0));
    return await (0, Jr.read)(t, i, 0, i.length, n - r.length - i.length), await (0, Jr.close)(t), i0(i);
  } catch (n) {
    throw await (0, Jr.close)(t), n;
  }
}
Object.defineProperty(_o, "__esModule", { value: !0 });
_o.AppImageUpdater = void 0;
const op = Xe, sp = ra, tx = ir, nx = x, Wi = k, rx = Ur, ix = Ho, ox = Ke, ap = or;
...
const fp = Xe, Wc = ir, mx = x, dp = k, gx = cv, yx = Zn, vx = Ke, hp = ra, pp = _i;
class Ex extends yx.AppUpdater {
  constructor(t, n) {
    super(t, n), this.nativeUpdater = An.autoUpdater, this.squirrelDownloadedUpdate = !1, this.nativeUpdater.on("error", (r) => {
    ...
    return await new Promise((u, l) => {
      ...
      this.server.on("request", (m, p) => {
        ...
        if (s.info(`${v} requested`), v === "/") {
          ...
          const w = m.headers.authorization.split(" ")[1], T = Buffer.from(w, "base64").toString("ascii"), [C, F] = T.split(":");
...
const bs = Xe, yp = k, bx = Ur, Tx = Ho, vp = or, Ax = Ke, Cx = ir, Nx = cf, Ep = rr;
class Ix extends bx.BaseUpdater {
  ...
  /*** @private */
  doDownloadUpdate(t) {
    const n = t.updateInfoAndProvider.provider, r = (0, Ax.findFile)(n.resolveFiles(t.updateInfoAndProvider.info), "exe");
    return this.executeDownload({
      fileExtension: "exe",
      downloadUpdateOptions: t,
      fileInfo: r,
  ...
  doInstall(t) {
    ...
    return t.isAdminRightsRequired ? (this._logger.info("isAdminRightsRequired is set to true, run installer using elevate.exe"), o(), !0) : (this.spawnLog(n, r).catch((s) => {
      const a = s.code;
      this._logger.info(`Cannot run installer: error code: ${a}, error message: "${s.message}", will be executed again using elevate if EACCES, and will try to use electron.shell.openItem if ENOENT`), a === "UNKNOWN" || a === "EACCES" ? o() : a === "ENOENT" ? An.shell.openPath(n).catch((c) => this.dispatchError(c)) : this.dispatchError(s);
    }), !0);
  }
  async differentialDownloadWebPackage(t, n, r, i) {
    ...
    try {
      ...
      this.listenerCount(vp.DOWNLOAD_PROGRESS) > 0 && (o.onProgress = (s) => this.emit(vp.DOWNLOAD_PROGRESS, s)), await new Tx.FileWithEmbeddedBlockMapDifferentialDownloader(n, this.httpExecutor, o).download();
    } catch (o) {
...
(function(e) {
  var t = Ct && Ct.__createBinding || (Object.create ? function(v, y, g, w) {
    w === void 0 && (w = g);
    var T = Object.getOwnPropertyDescriptor(y, g);
...
const Px = wp(import.meta.url), Fr = _p(Px), wt = process.env.VITE_DEV_SERVER_URL;
function Ox() {
  const e = [
    oe.instances,
    oe.java,
...
function Ts() {
  const e = new $e({
    ...
    title: "Fernlaunch",
    webPreferences: {
      preload: ct(Fr, "../dist-electron/preload.cjs"),
      sandbox: !1
    },
    icon: ct(tt.getAppPath(), "public/iconreal.ico")
  });
  return e.setMenuBarVisibility(!1), wt ? (console.log("Main window loading URL:", wt), e.loadURL(wt)) : e.loadFile(ct(tt.getAppPath(), "dist/index.html")), e;
}
function Rx() {
  const e = new $e({
    width: 600,
  ...
  return e.setMenuBarVisibility(!1), wt ? (console.log("First launch loading URL:", wt), e.loadURL(wt + "?firstLaunch=true")) : e.loadFile(ct(tt.getAppPath(), "dist/index.html"), {
...
function Dx() {
  ...
  return e.setMenuBarVisibility(!1), wt ? e.loadURL(wt + "?window=newInstance") : e.loadFile(ct(tt.getAppPath(), "dist/index.html"), {
...
function Fx() {
  ...
  return e.setMenuBarVisibility(!1), wt ? e.loadURL(wt + "?window=settings") : e.loadFile(ct(tt.getAppPath(), "dist/index.html"), {
...
function Lx(e) {
  ...
  return t.setMenuBarVisibility(!1), U1(e, t), wt ? t.loadURL(wt + `?window=console&instanceId=${e}`) : t.loadFile(ct(tt.getAppPath(), "dist/index.html"), {
    query: { window: "console", instanceId: e }
  }), t;
}
tt.whenReady().then(() => {
  if (WN(), K1(), J1(), X1(), Z1(), Ox(), tt.isPackaged && (ei.autoUpdater.checkForUpdatesAndNotify(), ei.autoUpdater.on("update-available", () => {
    var n;
    (n = $e.getAllWindows()[0]) == null || n.webContents.send("update:available");
  }), ei.autoUpdater.on("update-downloaded", () => {
    var n;
    (n = $e.getAllWindows()[0]) == null || n.webContents.send("update:downloaded");
  }), ei.autoUpdater.on("download-progress", (n) => {
    var r;
    (r = $e.getAllWindows()[0]) == null || r.webContents.send("update:progress", Math.round(n.percent));
  })), ie.handle("update:install", () => {
    ei.autoUpdater.quitAndInstall();
    ...
    i.setMenuBarVisibility(!1), wt ? i.loadURL(wt + `?window=instanceEditor&instanceId=${r}`) : i.loadFile(ct(tt.getAppPath(), "dist/index.html"), {
    ...
    n.setMenuBarVisibility(!1), wt ? n.loadURL(wt + "?window=about") : n.loadFile(ct(tt.getAppPath(), "dist/index.html"), { query: { window: "about" } });
  }), fn.get("firstLaunch")) {
    const n = Rx();
    ie.once("first-launch-complete", () => {
      fn.set("firstLaunch", !1), n.close(), Ts();
    });
  } else
    Ts();
  tt.on("activate", () => {
    $e.getAllWindows().length === 0 && Ts();
  });
  const t = process.argv.find((n) => n.startsWith("--instance"));
  if (t) {
    const n = t.split("=")[1] ?? process.argv[process.argv.indexOf(t) + 1], r = Ts();
